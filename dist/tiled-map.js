...
jsonAsset.ccenum(TMXObjectType);
var TMXTilesetInfo = function () {
  function TMXTilesetInfo() {
    ...
    this.imageName = null;
    this.imageSize = new jsonAsset.Size$1(0, 0);
    this.tileOffset = new jsonAsset.Vec2(0, 0);
    this._tileSize = new jsonAsset.Size$1(0, 0);
  ...
  _proto.rectForGID = function rectForGID(gid_, result) {
    var rect = result || new jsonAsset.Rect$1(0, 0, 0, 0);
...
var TMXObjectGroupInfo = function () {
  function TMXObjectGroupInfo() {
    ...
    this.visible = true;
    this.opacity = 0;
    this.color = new jsonAsset.Color$1(255, 255, 255, 255);
    this.offset = new jsonAsset.Vec2(0, 0);
...
var TMXImageLayerInfo = function TMXImageLayerInfo() {
  ...
  this.offset = new jsonAsset.Vec2(0, 0);
  this.opacity = 0;
  this.trans = new jsonAsset.Color$1(255, 255, 255, 255);
  this.sourceImage = void 0;
  this.tintColor = null;
};
...
function strToHAlign(value) {
  var hAlign = sprite.Label.HorizontalAlign;
...
function strToVAlign(value) {
  var vAlign = sprite.Label.VerticalAlign;
...
function strToColor(value) {
  ...
  if (value.length === 8) {
    ...
    return new jsonAsset.Color$1(r, g, b, a);
  } else {
    ...
    return new jsonAsset.Color$1(_r, _g, _b, 255);
  }
}
...
var TMXMapInfo = function () {
  jsonAsset._createClass(TMXMapInfo, [{
    key: "mapSize",
    get: function get() {
  ...
  function TMXMapInfo(tmxFile, tsxContentMap, spfTexturesMap, textureSizes, imageLayerTextures) {
    ...
    this._objectGroups = [];
    this._allChildren = [];
    this._mapSize = new jsonAsset.Size$1(0, 0);
    this._tileSize = new jsonAsset.Size$1(0, 0);
    this._layers = [];
    this._tilesets = [];
    this._imageLayers = [];
  ...
  _proto.getMapSize = function getMapSize() {
    return new jsonAsset.Size$1(this._mapSize.width, this._mapSize.height);
  };
  ...
  _proto.getTileSize = function getTileSize() {
    return new jsonAsset.Size$1(this._tileSize.width, this._tileSize.height);
  };
  ...
  _proto.parseXMLString = function parseXMLString(xmlStr, tilesetFirstGid) {
    var parser = new index.SAXParser();
    ...
    if (map.nodeName === 'map') {
      ...
      for (i = 0; i < supportVersion.length; i++) {
        ...
        if (sv < v) {
          jsonAsset.logID(7216, version);
          break;
        }
      }

      if (orientationStr === 'orthogonal') this.orientation = Orientation.ORTHO;else if (orientationStr === 'isometric') this.orientation = Orientation.ISO;else if (orientationStr === 'hexagonal') this.orientation = Orientation.HEX;else if (orientationStr !== null) jsonAsset.logID(7217, orientationStr);
      ...
      var mapSize = new jsonAsset.Size$1(0, 0);
      mapSize.width = parseFloat(map.getAttribute('width'));
      mapSize.height = parseFloat(map.getAttribute('height'));
      this.setMapSize(mapSize);
      mapSize = new jsonAsset.Size$1(0, 0);
    ...
    for (i = 0; i < tilesets.length; i++) {
      ...
      if (tsxName) {
        ...
        var tilesetSize = new jsonAsset.Size$1(0, 0);
              ...
              if (!tileset.sourceImage) {
                ...
                if (!tileset.sourceImage) {
                  ...
                  if (!tileset.sourceImage) {
                    ...
                    jsonAsset.errorID(7221, curImageName);
          ...
          if (tileImages && tileImages.length > 0) {
            ...
            if (!tileset.sourceImage) {
              ...
              if (!tileset.sourceImage) {
                ...
                if (!tileset.sourceImage) {
                  jsonAsset.errorID(7221, imageName);
  ...
  _proto._parseLayer = function _parseLayer(selLayer) {
    ...
    var layerSize = new jsonAsset.Size$1(0, 0);
    ...
    layer.offset = new jsonAsset.Vec2(parseFloat(selLayer.getAttribute('offsetx')) || 0, parseFloat(selLayer.getAttribute('offsety')) || 0);
    var tintColor = selLayer.getAttribute('tintcolor');
    ...
    switch (compression) {
      case 'gzip':
        tiles = ZipUtils.codec.unzipBase64AsArray(nodeValue, 4);
        break;

      case 'zlib':
        {
          var inflator = new ZipUtils._p.Inflate(ZipUtils.codec.Base64.decodeAsArray(nodeValue, 1));
      ...
      case null:
      case '':
        if (encoding === 'base64') tiles = ZipUtils.codec.Base64.decodeAsArray(nodeValue, 4);else if (encoding === 'csv') {
          tiles = [];
      ...
      default:
        if (this.layerAttrs === TMXLayerInfo.ATTRIB_NONE) jsonAsset.logID(7219);
        break;
    }
  ...
  _proto._parseObjectGroup = function _parseObjectGroup(selGroup) {
    ...
    objectGroup.offset = new jsonAsset.Vec2(parseFloat(selGroup.getAttribute('offsetx')), parseFloat(selGroup.getAttribute('offsety')));
...
var TiledTile = (_dec = jsonAsset.ccclass('cc.TiledTile'), _dec2 = jsonAsset.help(), _dec3 = jsonAsset.menu(), _dec4 = jsonAsset.requireComponent(renderable2d.UITransform), _dec5 = jsonAsset.type(jsonAsset.CCInteger), _dec6 = jsonAsset.type(jsonAsset.CCInteger), _dec7 = jsonAsset.type(jsonAsset.CCInteger), _dec8 = jsonAsset.type(jsonAsset.CCInteger), _dec9 = jsonAsset.type(jsonAsset.CCInteger), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = jsonAsset.executeInEditMode(_class = (_class2 = (_temp = function (_Component) {
  jsonAsset._inheritsLoose(TiledTile, _Component);
  ...
  function TiledTile() {
    ...
    jsonAsset._initializerDefineProperty(_this, "_x", _descriptor, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_y", _descriptor2, jsonAsset._assertThisInitialized(_this));
  ...
  _proto.updateInfo = function updateInfo() {
    ...
    if (this._layer.getTiledTileAt(x, y)) {
      jsonAsset.warn('There is already a TiledTile at [%s, %s]', x, y);
      return;
    }
  ...
  jsonAsset._createClass(TiledTile, [{
    key: "x",
    get: function get() {
      return this._x;
    },
    set: function set(value) {
      ...
      if (this._layer && this._layer.isInvalidPosition(value, this._y)) {
        jsonAsset.warn("Invalid x, the valid value is between [%s] ~ [%s]", 0, this._layer.layerSize.width);
        return;
      }
    ...
    set: function set(value) {
      ...
      if (this._layer && this._layer.isInvalidPosition(this._x, value)) {
        jsonAsset.warn("Invalid y, the valid value is between [%s] ~ [%s]", 0, this._layer.layerSize.height);
        return;
      }
  ...
  return TiledTile;
}(jsonAsset.Component), _temp), (_descriptor = jsonAsset._applyDecoratedDescriptor(_class2.prototype, "_x", [_dec5], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor2 = jsonAsset._applyDecoratedDescriptor(_class2.prototype, "_y", [_dec6], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), jsonAsset._applyDecoratedDescriptor(_class2.prototype, "x", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "x"), _class2.prototype), jsonAsset._applyDecoratedDescriptor(_class2.prototype, "y", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "y"), _class2.prototype), jsonAsset._applyDecoratedDescriptor(_class2.prototype, "grid", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "grid"), _class2.prototype)), _class2)) || _class) || _class) || _class) || _class) || _class);
  ...
  for (; gid < maxGid; ++gid) {
    ...
    if (!spFrame || count > 1) {
      if (spFrame) {
        ...
        grid._rect = new jsonAsset.Rect$1(grid.x, grid.y, grid.width, grid.height);
      } else {
...
var _vec3_temp = new jsonAsset.Vec3();

var _vec3_temp2 = new jsonAsset.Vec3();

var _tempRowCol = {
  row: 0,
  col: 0
};
var TiledUserNodeData = (_dec$1 = jsonAsset.ccclass('cc.TiledUserNodeData'), _dec$1(_class$1 = (_temp$1 = function (_Component) {
  jsonAsset._inheritsLoose(TiledUserNodeData, _Component);
...
}(jsonAsset.Component), _temp$1)) || _class$1);
var TiledLayer = (_dec2$1 = jsonAsset.ccclass('cc.TiledLayer'), _dec2$1(_class3 = (_temp2 = function (_Renderable2D) {
  jsonAsset._inheritsLoose(TiledLayer, _Renderable2D);

  jsonAsset._createClass(TiledLayer, [{
    key: "cullingRect",
    get: function get() {
  ...
  _proto.addUserNode = function addUserNode(node) {
    ...
    if (dataComp) {
      jsonAsset.warn('CCTiledLayer:addUserNode node has been added');
      return false;
    }
    ...
    node.on(jsonAsset.NodeEventType.TRANSFORM_CHANGED, this._userNodePosChange, dataComp);
    node.on(jsonAsset.NodeEventType.SIZE_CHANGED, this._userNodeSizeChange, dataComp);
    return true;
  };
  ...
  _proto.removeUserNode = function removeUserNode(node) {
    ...
    if (!dataComp) {
      jsonAsset.warn('CCTiledLayer:removeUserNode node is not exist');
      return false;
    }

    node.off(jsonAsset.NodeEventType.TRANSFORM_CHANGED, this._userNodePosChange, dataComp);
    node.off(jsonAsset.NodeEventType.SIZE_CHANGED, this._userNodeSizeChange, dataComp);
  ...
  _proto.onEnable = function onEnable() {
    ...
    this.node.on(jsonAsset.NodeEventType.ANCHOR_CHANGED, this._syncAnchorPoint, this);
    this.node.on(jsonAsset.NodeEventType.TRANSFORM_CHANGED, this.updateCulling, this);
    this.node.on(jsonAsset.NodeEventType.SIZE_CHANGED, this.updateCulling, this);
    this.node.parent.on(jsonAsset.NodeEventType.TRANSFORM_CHANGED, this.updateCulling, this);
    this.node.parent.on(jsonAsset.NodeEventType.SIZE_CHANGED, this.updateCulling, this);
    this.markForUpdateRenderData();
  ...
  _proto.onDisable = function onDisable() {
    ...
    this.node.parent.off(jsonAsset.NodeEventType.SIZE_CHANGED, this.updateCulling, this);
    this.node.parent.off(jsonAsset.NodeEventType.TRANSFORM_CHANGED, this.updateCulling, this);
    this.node.off(jsonAsset.NodeEventType.SIZE_CHANGED, this.updateCulling, this);
    this.node.off(jsonAsset.NodeEventType.TRANSFORM_CHANGED, this.updateCulling, this);
    this.node.off(jsonAsset.NodeEventType.ANCHOR_CHANGED, this._syncAnchorPoint, this);
  };
  ...
  _proto._positionForIsoAt = function _positionForIsoAt(x, y) {
    ...
    return new jsonAsset.Vec2(this._mapTileSize.width * 0.5 * (this._layerSize.height + x - y - 1) + offsetX, this._mapTileSize.height * 0.5 * (this._layerSize.width - x + this._layerSize.height - y - 2) - offsetY);
  };
  ...
  _proto._positionForOrthoAt = function _positionForOrthoAt(x, y) {
    ...
    return new jsonAsset.Vec2(x * this._mapTileSize.width + offsetX, (this._layerSize.height - y - 1) * this._mapTileSize.height - offsetY);
  };
  ...
  _proto.setTileGIDAt = function setTileGIDAt(gid, x, y, flags) {
    ...
    if (!this.tiles || !this._tilesets || this._tilesets.length === 0) {
      jsonAsset.logID(7238);
      return;
    }

    if (ugid !== 0 && ugid < this._tilesets[0].firstGid) {
      jsonAsset.logID(7239, gid);
      return;
    }
  ...
  _proto.updateCulling = function updateCulling() {
    if (this._enableCulling) {
      ...
      jsonAsset.Mat4.invert(_mat4_temp, this.node.getWorldMatrix());
      ...
      if (camera) {
        ...
        jsonAsset.Vec3.transformMat4(_vec3_temp, _vec3_temp, _mat4_temp);
        jsonAsset.Vec3.transformMat4(_vec3_temp2, _vec3_temp2, _mat4_temp);
  ...
  _proto.init = function init(layerInfo, mapInfo, tilesets, textures, texGrids) {
    ...
    this._offset = new jsonAsset.Vec2(layerInfo.offset.x, -layerInfo.offset.y);
  ...
  _proto.requestMeshRenderData = function requestMeshRenderData() {
    ...
    Object.defineProperty(renderData, 'material', {
      get: function get() {
        return _this3.getRenderMaterial(0);
      }
    });
  ...
  return TiledLayer;
}(renderable2d.Renderable2D), _temp2)) || _class3);

var _dec$2, _dec2$2, _dec3$1, _dec4$1, _class$2, _class2$1, _temp$2;
var TiledObjectGroup = (_dec$2 = jsonAsset.ccclass('cc.TiledObjectGroup'), _dec2$2 = jsonAsset.help(), _dec3$1 = jsonAsset.requireComponent(renderable2d.UITransform), _dec4$1 = jsonAsset.type(jsonAsset.CCBoolean), _dec$2(_class$2 = _dec2$2(_class$2 = _dec3$1(_class$2 = (_class2$1 = (_temp$2 = function (_Component) {
  jsonAsset._inheritsLoose(TiledObjectGroup, _Component);
  ...
  _proto._init = function _init(groupInfo, mapInfo, texGrids) {
    ...
    this._offset = new jsonAsset.Vec2(groupInfo.offset.x, -groupInfo.offset.y);
    ...
    var width = 0;
    var height = 0;
    var colorVal = new jsonAsset.Color$1();
    ...
    for (var i = 0, l = objects.length; i < l; i++) {
      ...
      object.offset = new jsonAsset.Vec2(object.x, object.y);
      ...
      if (objType === TMXObjectType.TEXT) {
        ...
        var label = textNode.getComponent(sprite.Label);

        if (!label) {
          label = textNode.addComponent(sprite.Label);
        }
        ...
        label.overflow = sprite.Label.Overflow.SHRINK;
        ...
        if (imgNode && imgNode._objFlags & jsonAsset.CCObject.Flags.HideInHierarchy) {
          imgNode.removeFromParent();
          imgNode.hideFlags |= jsonAsset.CCObject.Flags.DontSave;
          imgNode.destroy();
          imgNode = null;
        }

        if (!imgNode) {
          imgNode = new jsonAsset.Node();
        }
        ...
        var sprite$1 = imgNode.getComponent(sprite.Sprite);

        if (!sprite$1) {
          sprite$1 = imgNode.addComponent(sprite.Sprite);
        }
        ...
        if (this._tintColor) {
          colorVal.set(this._tintColor);
          colorVal.a *= this._opacity / 255;
          sprite$1.color.set(colorVal);
        } else {
          var _c = sprite$1.color;
          _c.a *= this._opacity / 255;
        }

        sprite$1.sizeMode = sprite.Sprite.SizeMode.CUSTOM;
        sprite$1._srcBlendFactor = this._premultiplyAlpha ? jsonAsset.BlendFactor.ONE : jsonAsset.BlendFactor.SRC_ALPHA;
        sprite$1._dstBlendFactor = jsonAsset.BlendFactor.ONE_MINUS_SRC_ALPHA;

        sprite$1._updateBlendFunc();

        var spf = grid.spriteFrame;

        if (!spf) {
          spf = new spriteFrame.SpriteFrame();
        } else {
          spf = spf.clone();
        }
        ...
        spf.rect = grid._rect;
        sprite$1.spriteFrame = spf;
        imgTrans.setContentSize(object.width, object.height);
        sprite$1.markForUpdateRenderData();
      }
    }
  ...
  _proto.update = function update(dt) {
    ...
    for (var i = 0, len = aniObjects.length; i < len; i++) {
      ...
      var sp = imgNode.getComponent(sprite.Sprite);
  ...
  jsonAsset._createClass(TiledObjectGroup, [{
...
}(jsonAsset.Component), _temp$2), (jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "premultiplyAlpha", [_dec4$1], Object.getOwnPropertyDescriptor(_class2$1.prototype, "premultiplyAlpha"), _class2$1.prototype)), _class2$1)) || _class$2) || _class$2) || _class$2);
...
var TiledMapAsset = (_dec$3 = jsonAsset.ccclass('cc.TiledMapAsset'), _dec2$3 = jsonAsset.type([jsonAsset.TextAsset]), _dec3$2 = jsonAsset.type([jsonAsset.CCString]), _dec4$2 = jsonAsset.type([spriteFrame.SpriteFrame]), _dec5$1 = jsonAsset.type([spriteFrame.SpriteFrame]), _dec6$1 = jsonAsset.type([jsonAsset.CCString]), _dec7$1 = jsonAsset.type([jsonAsset.CCString]), _dec8$1 = jsonAsset.type([jsonAsset.Size$1]), _dec$3(_class$3 = (_class2$2 = (_temp$3 = function (_Asset) {
  jsonAsset._inheritsLoose(TiledMapAsset, _Asset);
  ...
  function TiledMapAsset() {
    ...
    jsonAsset._initializerDefineProperty(_this, "tmxXmlStr", _descriptor$1, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "tsxFiles", _descriptor2$1, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "tsxFileNames", _descriptor3, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "spriteFrames", _descriptor4, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "imageLayerSpriteFrame", _descriptor5, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "imageLayerSpriteFrameNames", _descriptor6, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "spriteFrameNames", _descriptor7, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "spriteFrameSizes", _descriptor8, jsonAsset._assertThisInitialized(_this));

    return _this;
  }

  return TiledMapAsset;
}(jsonAsset.Asset), _temp$3), (_descriptor$1 = jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "tmxXmlStr", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor2$1 = jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "tsxFiles", [jsonAsset.serializable, _dec2$3], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor3 = jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "tsxFileNames", [jsonAsset.serializable, _dec3$2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor4 = jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "spriteFrames", [jsonAsset.serializable, _dec4$2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor5 = jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "imageLayerSpriteFrame", [jsonAsset.serializable, _dec5$1], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor6 = jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "imageLayerSpriteFrameNames", [jsonAsset.serializable, _dec6$1], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor7 = jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "spriteFrameNames", [jsonAsset.serializable, _dec7$1], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor8 = jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "spriteFrameSizes", [jsonAsset.serializable, _dec8$1], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
var TiledMap = (_dec$4 = jsonAsset.ccclass('cc.TiledMap'), _dec2$4 = jsonAsset.help(), _dec3$3 = jsonAsset.menu(), _dec4$3 = jsonAsset.requireComponent(renderable2d.UITransform), _dec5$2 = jsonAsset.type(TiledMapAsset), _dec6$2 = jsonAsset.displayOrder(), _dec$4(_class$4 = _dec2$4(_class$4 = _dec3$3(_class$4 = _dec4$3(_class$4 = jsonAsset.executeInEditMode(_class$4 = (_class2$3 = (_temp$4 = _class3$1 = function (_Component) {
  jsonAsset._inheritsLoose(TiledMap, _Component);
  ...
  function TiledMap() {
    ...
    _this._mapInfo = null;
    _this._mapSize = new jsonAsset.Size$1(0, 0);
    _this._tileSize = new jsonAsset.Size$1(0, 0);
    _this._preloaded = false;
    _this._mapOrientation = Orientation.ORTHO;

    jsonAsset._initializerDefineProperty(_this, "_tmxFile", _descriptor$2, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_enableCulling", _descriptor2$2, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "cleanupImageCache", _descriptor3$1, jsonAsset._assertThisInitialized(_this));
  ...
  _proto._fillAniGrids = function _fillAniGrids(texGrids, animations) {
    for (var _iterator = jsonAsset._createForOfIteratorHelperLoose(animations.keys()), _step; !(_step = _iterator()).done;) {
      var i = _step.value;
    ...
    if (layerInfos && layerInfos.length > 0) {
      for (var _i8 = 0, len = layerInfos.length; _i8 < len; _i8++) {
        ...
        if (layerInfo instanceof TMXLayerInfo) {
          ...
          child._offset = new jsonAsset.Vec2(layerInfo.offset.x, -layerInfo.offset.y);
          var image = child.getComponent(sprite.Sprite);

          if (!image) {
            image = child.addComponent(sprite.Sprite);
          }
  ...
  _proto.doCleanupImageCache = function doCleanupImageCache(texture) {
    if (texture._image instanceof HTMLImageElement) {
      texture._image.src = '';
    } else if (jsonAsset.sys.capabilities.imageBitmap && texture._image instanceof ImageBitmap) {
  ...
  _proto.update = function update(dt) {
    ...
    for (var _iterator2 = jsonAsset._createForOfIteratorHelperLoose(animations.keys()), _step2; !(_step2 = _iterator2()).done;) {
    ...
    for (var _iterator3 = jsonAsset._createForOfIteratorHelperLoose(this.getLayers()), _step3; !(_step3 = _iterator3()).done;) {
  ...
  jsonAsset._createClass(TiledMap, [{
    key: "tmxAsset",
    get: function get() {
      return this._tmxFile;
    },
    set: function set(value) {
      if (this._tmxFile !== value || jsonAsset.EDITOR) {
        this._tmxFile = value;

        if (this._preloaded || jsonAsset.EDITOR) {
          this._applyFile();
        }
      }
    }
  ...
  return TiledMap;
}(jsonAsset.Component), _class3$1.Orientation = Orientation, _class3$1.Property = Property, _class3$1.TileFlag = TileFlag, _class3$1.StaggerAxis = StaggerAxis, _class3$1.StaggerIndex = StaggerIndex, _class3$1.TMXObjectType = TMXObjectType, _class3$1.RenderOrder = RenderOrder, _temp$4), (_descriptor$2 = jsonAsset._applyDecoratedDescriptor(_class2$3.prototype, "_tmxFile", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), jsonAsset._applyDecoratedDescriptor(_class2$3.prototype, "tmxAsset", [_dec5$2, _dec6$2], Object.getOwnPropertyDescriptor(_class2$3.prototype, "tmxAsset"), _class2$3.prototype), _descriptor2$2 = jsonAsset._applyDecoratedDescriptor(_class2$3.prototype, "_enableCulling", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), jsonAsset._applyDecoratedDescriptor(_class2$3.prototype, "enableCulling", [jsonAsset.editable], Object.getOwnPropertyDescriptor(_class2$3.prototype, "enableCulling"), _class2$3.prototype), _descriptor3$1 = jsonAsset._applyDecoratedDescriptor(_class2$3.prototype, "cleanupImageCache", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
for (var i = 0; i < 4; i++) {
  vec3_temps.push(new jsonAsset.Vec3());
}

var _mat4_temp$1 = new jsonAsset.Mat4();
...
var simple = {
  ...
  updateColor: function updateColor(tiled) {
    ...
    if (rs) {
      for (var _iterator = jsonAsset._createForOfIteratorHelperLoose(rs), _step; !(_step = _iterator()).done;) {
        var r = _step.value;
...
function fillByTiledNode(tiledNode, color, vbuf, left, right, top, bottom, diamondTile) {
  ...
  jsonAsset.Mat4.fromRTS(_mat4_temp$1, tiledNode.getRotation(), tiledNode.getPosition(), tiledNode.getScale());
  jsonAsset.Vec3.set(_vec3u_temp, -(left + _moveX), -(bottom + _moveY), 0);
  jsonAsset.Mat4.transform(_mat4_temp$1, _mat4_temp$1, _vec3u_temp);
  var m = _mat4_temp$1;
  var tx = m.m12;
  var ty = m.m13;
  var a = m.m00;
...
exports.tiledLayerAssembler = tiledLayerAssembler;
