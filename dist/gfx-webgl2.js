...
var webglDefine = require('./webgl-define-2d581a76.js');

var WebGL2DescriptorSet = function (_DescriptorSet) {
  jsonAsset._inheritsLoose(WebGL2DescriptorSet, _DescriptorSet);
  ...
  _proto.update = function update() {
    if (this._isDirty && this._gpuDescriptorSet) {
      ...
      for (var i = 0; i < descriptors.length; ++i) {
        if (descriptors[i].type & jsonAsset.DESCRIPTOR_BUFFER_TYPE) {
          if (this._buffers[i]) {
            descriptors[i].gpuBuffer = this._buffers[i].gpuBuffer;
          }
        } else if (descriptors[i].type & jsonAsset.DESCRIPTOR_SAMPLER_TYPE) {
          if (this._textures[i]) {
  ...
  jsonAsset._createClass(WebGL2DescriptorSet, [{
...
function GFXFormatToWebGLType(format, gl) {
  switch (format) {
    case jsonAsset.Format.R8:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.R8SN:
      return gl.BYTE;

    case jsonAsset.Format.R8UI:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.R8I:
      return gl.BYTE;

    case jsonAsset.Format.R16F:
      return gl.HALF_FLOAT;

    case jsonAsset.Format.R16UI:
      return gl.UNSIGNED_SHORT;

    case jsonAsset.Format.R16I:
      return gl.SHORT;

    case jsonAsset.Format.R32F:
      return gl.FLOAT;

    case jsonAsset.Format.R32UI:
      return gl.UNSIGNED_INT;

    case jsonAsset.Format.R32I:
      return gl.INT;

    case jsonAsset.Format.RG8:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.RG8SN:
      return gl.BYTE;

    case jsonAsset.Format.RG8UI:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.RG8I:
      return gl.BYTE;

    case jsonAsset.Format.RG16F:
      return gl.HALF_FLOAT;

    case jsonAsset.Format.RG16UI:
      return gl.UNSIGNED_SHORT;

    case jsonAsset.Format.RG16I:
      return gl.SHORT;

    case jsonAsset.Format.RG32F:
      return gl.FLOAT;

    case jsonAsset.Format.RG32UI:
      return gl.UNSIGNED_INT;

    case jsonAsset.Format.RG32I:
      return gl.INT;

    case jsonAsset.Format.RGB8:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.SRGB8:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.RGB8SN:
      return gl.BYTE;

    case jsonAsset.Format.RGB8UI:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.RGB8I:
      return gl.BYTE;

    case jsonAsset.Format.RGB16F:
      return gl.HALF_FLOAT;

    case jsonAsset.Format.RGB16UI:
      return gl.UNSIGNED_SHORT;

    case jsonAsset.Format.RGB16I:
      return gl.SHORT;

    case jsonAsset.Format.RGB32F:
      return gl.FLOAT;

    case jsonAsset.Format.RGB32UI:
      return gl.UNSIGNED_INT;

    case jsonAsset.Format.RGB32I:
      return gl.INT;

    case jsonAsset.Format.BGRA8:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.RGBA8:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.SRGB8_A8:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.RGBA8SN:
      return gl.BYTE;

    case jsonAsset.Format.RGBA8UI:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.RGBA8I:
      return gl.BYTE;

    case jsonAsset.Format.RGBA16F:
      return gl.HALF_FLOAT;

    case jsonAsset.Format.RGBA16UI:
      return gl.UNSIGNED_SHORT;

    case jsonAsset.Format.RGBA16I:
      return gl.SHORT;

    case jsonAsset.Format.RGBA32F:
      return gl.FLOAT;

    case jsonAsset.Format.RGBA32UI:
      return gl.UNSIGNED_INT;

    case jsonAsset.Format.RGBA32I:
      return gl.INT;

    case jsonAsset.Format.R5G6B5:
      return gl.UNSIGNED_SHORT_5_6_5;

    case jsonAsset.Format.R11G11B10F:
      return gl.UNSIGNED_INT_10F_11F_11F_REV;

    case jsonAsset.Format.RGB5A1:
      return gl.UNSIGNED_SHORT_5_5_5_1;

    case jsonAsset.Format.RGBA4:
      return gl.UNSIGNED_SHORT_4_4_4_4;

    case jsonAsset.Format.RGB10A2:
      return gl.UNSIGNED_INT_2_10_10_10_REV;

    case jsonAsset.Format.RGB10A2UI:
      return gl.UNSIGNED_INT_2_10_10_10_REV;

    case jsonAsset.Format.RGB9E5:
      return gl.FLOAT;

    case jsonAsset.Format.D16:
      return gl.UNSIGNED_SHORT;

    case jsonAsset.Format.D16S8:
      return gl.UNSIGNED_INT_24_8;

    case jsonAsset.Format.D24:
      return gl.UNSIGNED_INT;

    case jsonAsset.Format.D24S8:
      return gl.UNSIGNED_INT_24_8;

    case jsonAsset.Format.D32F:
      return gl.FLOAT;

    case jsonAsset.Format.D32F_S8:
      return gl.FLOAT_32_UNSIGNED_INT_24_8_REV;

    case jsonAsset.Format.BC1:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.BC1_SRGB:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.BC2:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.BC2_SRGB:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.BC3:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.BC3_SRGB:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.BC4:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.BC4_SNORM:
      return gl.BYTE;

    case jsonAsset.Format.BC5:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.BC5_SNORM:
      return gl.BYTE;

    case jsonAsset.Format.BC6H_SF16:
      return gl.FLOAT;

    case jsonAsset.Format.BC6H_UF16:
      return gl.FLOAT;

    case jsonAsset.Format.BC7:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.BC7_SRGB:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.ETC_RGB8:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.ETC2_RGB8:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.ETC2_SRGB8:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.ETC2_RGB8_A1:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.ETC2_SRGB8_A1:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.EAC_R11:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.EAC_R11SN:
      return gl.BYTE;

    case jsonAsset.Format.EAC_RG11:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.EAC_RG11SN:
      return gl.BYTE;

    case jsonAsset.Format.PVRTC_RGB2:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.PVRTC_RGBA2:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.PVRTC_RGB4:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.PVRTC_RGBA4:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.PVRTC2_2BPP:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.PVRTC2_4BPP:
      return gl.UNSIGNED_BYTE;

    case jsonAsset.Format.ASTC_RGBA_4X4:
    case jsonAsset.Format.ASTC_RGBA_5X4:
    case jsonAsset.Format.ASTC_RGBA_5X5:
    case jsonAsset.Format.ASTC_RGBA_6X5:
    case jsonAsset.Format.ASTC_RGBA_6X6:
    case jsonAsset.Format.ASTC_RGBA_8X5:
    case jsonAsset.Format.ASTC_RGBA_8X6:
    case jsonAsset.Format.ASTC_RGBA_8X8:
    case jsonAsset.Format.ASTC_RGBA_10X5:
    case jsonAsset.Format.ASTC_RGBA_10X6:
    case jsonAsset.Format.ASTC_RGBA_10X8:
    case jsonAsset.Format.ASTC_RGBA_10X10:
    case jsonAsset.Format.ASTC_RGBA_12X10:
    case jsonAsset.Format.ASTC_RGBA_12X12:
    case jsonAsset.Format.ASTC_SRGBA_4X4:
    case jsonAsset.Format.ASTC_SRGBA_5X4:
    case jsonAsset.Format.ASTC_SRGBA_5X5:
    case jsonAsset.Format.ASTC_SRGBA_6X5:
    case jsonAsset.Format.ASTC_SRGBA_6X6:
    case jsonAsset.Format.ASTC_SRGBA_8X5:
    case jsonAsset.Format.ASTC_SRGBA_8X6:
    case jsonAsset.Format.ASTC_SRGBA_8X8:
    case jsonAsset.Format.ASTC_SRGBA_10X5:
    case jsonAsset.Format.ASTC_SRGBA_10X6:
    case jsonAsset.Format.ASTC_SRGBA_10X8:
    case jsonAsset.Format.ASTC_SRGBA_10X10:
    case jsonAsset.Format.ASTC_SRGBA_12X10:
    case jsonAsset.Format.ASTC_SRGBA_12X12:
      return gl.UNSIGNED_BYTE;
...
function GFXFormatToWebGLInternalFormat(format, gl) {
  switch (format) {
    case jsonAsset.Format.A8:
      return gl.ALPHA;

    case jsonAsset.Format.L8:
      return gl.LUMINANCE;

    case jsonAsset.Format.LA8:
    ...
    case jsonAsset.Format.BC1:
      return webglDefine.WebGLEXT.COMPRESSED_RGB_S3TC_DXT1_EXT;

    case jsonAsset.Format.BC1_ALPHA:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_S3TC_DXT1_EXT;

    case jsonAsset.Format.BC1_SRGB:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB_S3TC_DXT1_EXT;

    case jsonAsset.Format.BC1_SRGB_ALPHA:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;

    case jsonAsset.Format.BC2:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_S3TC_DXT3_EXT;

    case jsonAsset.Format.BC2_SRGB:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;

    case jsonAsset.Format.BC3:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_S3TC_DXT5_EXT;

    case jsonAsset.Format.BC3_SRGB:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT;

    case jsonAsset.Format.ETC_RGB8:
      return webglDefine.WebGLEXT.COMPRESSED_RGB_ETC1_WEBGL;

    case jsonAsset.Format.ETC2_RGB8:
      return webglDefine.WebGLEXT.COMPRESSED_RGB8_ETC2;

    case jsonAsset.Format.ETC2_SRGB8:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB8_ETC2;

    case jsonAsset.Format.ETC2_RGB8_A1:
      return webglDefine.WebGLEXT.COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2;

    case jsonAsset.Format.ETC2_SRGB8_A1:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2;

    case jsonAsset.Format.ETC2_RGBA8:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA8_ETC2_EAC;

    case jsonAsset.Format.ETC2_SRGB8_A8:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC;

    case jsonAsset.Format.EAC_R11:
      return webglDefine.WebGLEXT.COMPRESSED_R11_EAC;

    case jsonAsset.Format.EAC_R11SN:
      return webglDefine.WebGLEXT.COMPRESSED_SIGNED_R11_EAC;

    case jsonAsset.Format.EAC_RG11:
      return webglDefine.WebGLEXT.COMPRESSED_RG11_EAC;

    case jsonAsset.Format.EAC_RG11SN:
      return webglDefine.WebGLEXT.COMPRESSED_SIGNED_RG11_EAC;

    case jsonAsset.Format.PVRTC_RGB2:
      return webglDefine.WebGLEXT.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;

    case jsonAsset.Format.PVRTC_RGBA2:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;

    case jsonAsset.Format.PVRTC_RGB4:
      return webglDefine.WebGLEXT.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;

    case jsonAsset.Format.PVRTC_RGBA4:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;

    case jsonAsset.Format.ASTC_RGBA_4X4:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_ASTC_4x4_KHR;

    case jsonAsset.Format.ASTC_RGBA_5X4:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_ASTC_5x4_KHR;

    case jsonAsset.Format.ASTC_RGBA_5X5:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_ASTC_5x5_KHR;

    case jsonAsset.Format.ASTC_RGBA_6X5:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_ASTC_6x5_KHR;

    case jsonAsset.Format.ASTC_RGBA_6X6:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_ASTC_6x6_KHR;

    case jsonAsset.Format.ASTC_RGBA_8X5:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_ASTC_8x5_KHR;

    case jsonAsset.Format.ASTC_RGBA_8X6:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_ASTC_8x6_KHR;

    case jsonAsset.Format.ASTC_RGBA_8X8:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_ASTC_8x8_KHR;

    case jsonAsset.Format.ASTC_RGBA_10X5:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_ASTC_10x5_KHR;

    case jsonAsset.Format.ASTC_RGBA_10X6:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_ASTC_10x6_KHR;

    case jsonAsset.Format.ASTC_RGBA_10X8:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_ASTC_10x8_KHR;

    case jsonAsset.Format.ASTC_RGBA_10X10:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_ASTC_10x10_KHR;

    case jsonAsset.Format.ASTC_RGBA_12X10:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_ASTC_12x10_KHR;

    case jsonAsset.Format.ASTC_RGBA_12X12:
      return webglDefine.WebGLEXT.COMPRESSED_RGBA_ASTC_12x12_KHR;

    case jsonAsset.Format.ASTC_SRGBA_4X4:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR;

    case jsonAsset.Format.ASTC_SRGBA_5X4:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR;

    case jsonAsset.Format.ASTC_SRGBA_5X5:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR;

    case jsonAsset.Format.ASTC_SRGBA_6X5:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR;

    case jsonAsset.Format.ASTC_SRGBA_6X6:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR;

    case jsonAsset.Format.ASTC_SRGBA_8X5:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR;

    case jsonAsset.Format.ASTC_SRGBA_8X6:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR;

    case jsonAsset.Format.ASTC_SRGBA_8X8:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR;

    case jsonAsset.Format.ASTC_SRGBA_10X5:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR;

    case jsonAsset.Format.ASTC_SRGBA_10X6:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR;

    case jsonAsset.Format.ASTC_SRGBA_10X8:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR;

    case jsonAsset.Format.ASTC_SRGBA_10X10:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR;

    case jsonAsset.Format.ASTC_SRGBA_12X10:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR;

    case jsonAsset.Format.ASTC_SRGBA_12X12:
      return webglDefine.WebGLEXT.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR;
...
function GFXTypeToWebGLType(type, gl) {
  switch (type) {
    case jsonAsset.Type.BOOL:
      return gl.BOOL;

    case jsonAsset.Type.BOOL2:
      return gl.BOOL_VEC2;

    case jsonAsset.Type.BOOL3:
      return gl.BOOL_VEC3;

    case jsonAsset.Type.BOOL4:
      return gl.BOOL_VEC4;

    case jsonAsset.Type.INT:
      return gl.INT;

    case jsonAsset.Type.INT2:
      return gl.INT_VEC2;

    case jsonAsset.Type.INT3:
      return gl.INT_VEC3;

    case jsonAsset.Type.INT4:
      return gl.INT_VEC4;

    case jsonAsset.Type.UINT:
      return gl.UNSIGNED_INT;

    case jsonAsset.Type.FLOAT:
      return gl.FLOAT;

    case jsonAsset.Type.FLOAT2:
      return gl.FLOAT_VEC2;

    case jsonAsset.Type.FLOAT3:
      return gl.FLOAT_VEC3;

    case jsonAsset.Type.FLOAT4:
      return gl.FLOAT_VEC4;

    case jsonAsset.Type.MAT2:
      return gl.FLOAT_MAT2;

    case jsonAsset.Type.MAT2X3:
      return gl.FLOAT_MAT2x3;

    case jsonAsset.Type.MAT2X4:
      return gl.FLOAT_MAT2x4;

    case jsonAsset.Type.MAT3X2:
      return gl.FLOAT_MAT3x2;

    case jsonAsset.Type.MAT3:
      return gl.FLOAT_MAT3;

    case jsonAsset.Type.MAT3X4:
      return gl.FLOAT_MAT3x4;

    case jsonAsset.Type.MAT4X2:
      return gl.FLOAT_MAT4x2;

    case jsonAsset.Type.MAT4X3:
      return gl.FLOAT_MAT4x3;

    case jsonAsset.Type.MAT4:
      return gl.FLOAT_MAT4;

    case jsonAsset.Type.SAMPLER2D:
      return gl.SAMPLER_2D;

    case jsonAsset.Type.SAMPLER2D_ARRAY:
      return gl.SAMPLER_2D_ARRAY;

    case jsonAsset.Type.SAMPLER3D:
      return gl.SAMPLER_3D;

    case jsonAsset.Type.SAMPLER_CUBE:
      return gl.SAMPLER_CUBE;

    default:
      {
        console.error('Unsupported GLType, convert to GL type failed.');
        return jsonAsset.Type.UNKNOWN;
      }
  }
}
...
function WebGLTypeToGFXType(glType, gl) {
  switch (glType) {
    case gl.BOOL:
      return jsonAsset.Type.BOOL;

    case gl.BOOL_VEC2:
      return jsonAsset.Type.BOOL2;

    case gl.BOOL_VEC3:
      return jsonAsset.Type.BOOL3;

    case gl.BOOL_VEC4:
      return jsonAsset.Type.BOOL4;

    case gl.INT:
      return jsonAsset.Type.INT;

    case gl.INT_VEC2:
      return jsonAsset.Type.INT2;

    case gl.INT_VEC3:
      return jsonAsset.Type.INT3;

    case gl.INT_VEC4:
      return jsonAsset.Type.INT4;

    case gl.UNSIGNED_INT:
      return jsonAsset.Type.UINT;

    case gl.UNSIGNED_INT_VEC2:
      return jsonAsset.Type.UINT2;

    case gl.UNSIGNED_INT_VEC3:
      return jsonAsset.Type.UINT3;

    case gl.UNSIGNED_INT_VEC4:
      return jsonAsset.Type.UINT4;

    case gl.FLOAT:
      return jsonAsset.Type.FLOAT;

    case gl.FLOAT_VEC2:
      return jsonAsset.Type.FLOAT2;

    case gl.FLOAT_VEC3:
      return jsonAsset.Type.FLOAT3;

    case gl.FLOAT_VEC4:
      return jsonAsset.Type.FLOAT4;

    case gl.FLOAT_MAT2:
      return jsonAsset.Type.MAT2;

    case gl.FLOAT_MAT2x3:
      return jsonAsset.Type.MAT2X3;

    case gl.FLOAT_MAT2x4:
      return jsonAsset.Type.MAT2X4;

    case gl.FLOAT_MAT3x2:
      return jsonAsset.Type.MAT3X2;

    case gl.FLOAT_MAT3:
      return jsonAsset.Type.MAT3;

    case gl.FLOAT_MAT3x4:
      return jsonAsset.Type.MAT3X4;

    case gl.FLOAT_MAT4x2:
      return jsonAsset.Type.MAT4X2;

    case gl.FLOAT_MAT4x3:
      return jsonAsset.Type.MAT4X3;

    case gl.FLOAT_MAT4:
      return jsonAsset.Type.MAT4;

    case gl.SAMPLER_2D:
      return jsonAsset.Type.SAMPLER2D;

    case gl.SAMPLER_2D_ARRAY:
      return jsonAsset.Type.SAMPLER2D_ARRAY;

    case gl.SAMPLER_3D:
      return jsonAsset.Type.SAMPLER3D;

    case gl.SAMPLER_CUBE:
      return jsonAsset.Type.SAMPLER_CUBE;
...
var WebGL2CmdBeginRenderPass = function (_WebGL2CmdObject) {
  jsonAsset._inheritsLoose(WebGL2CmdBeginRenderPass, _WebGL2CmdObject);
  ...
  function WebGL2CmdBeginRenderPass() {
    ...
    _this.renderArea = new jsonAsset.Rect();
    _this.clearColors = [];
...
var WebGL2CmdBindStates = function (_WebGL2CmdObject2) {
  jsonAsset._inheritsLoose(WebGL2CmdBindStates, _WebGL2CmdObject2);
  ...
  function WebGL2CmdBindStates() {
    ...
    _this2.dynamicStates = new jsonAsset.DynamicStates();
    return _this2;
  }
...
var WebGL2CmdDraw = function (_WebGL2CmdObject3) {
  jsonAsset._inheritsLoose(WebGL2CmdDraw, _WebGL2CmdObject3);

  function WebGL2CmdDraw() {
    var _this3;

    _this3 = _WebGL2CmdObject3.call(this, WebGL2Cmd.DRAW) || this;
    _this3.drawInfo = new jsonAsset.DrawInfo();
    return _this3;
  }
...
var WebGL2CmdUpdateBuffer = function (_WebGL2CmdObject4) {
  jsonAsset._inheritsLoose(WebGL2CmdUpdateBuffer, _WebGL2CmdObject4);
...
var WebGL2CmdCopyBufferToTexture = function (_WebGL2CmdObject5) {
  jsonAsset._inheritsLoose(WebGL2CmdCopyBufferToTexture, _WebGL2CmdObject5);
...
var WebGL2CmdPackage = function () {
  function WebGL2CmdPackage() {
    this.cmds = new jsonAsset.CachedArray(1);
    this.beginRenderPassCmds = new jsonAsset.CachedArray(1);
    this.bindStatesCmds = new jsonAsset.CachedArray(1);
    this.drawCmds = new jsonAsset.CachedArray(1);
    this.updateBufferCmds = new jsonAsset.CachedArray(1);
    this.copyBufferToTextureCmds = new jsonAsset.CachedArray(1);
  }
...
function WebGL2CmdFuncCreateBuffer(device, gpuBuffer) {
  ...
  var glUsage = gpuBuffer.memUsage & jsonAsset.MemoryUsageBit.HOST ? gl.DYNAMIC_DRAW : gl.STATIC_DRAW;

  if (gpuBuffer.usage & jsonAsset.BufferUsageBit.VERTEX) {
  ...
  } else if (gpuBuffer.usage & jsonAsset.BufferUsageBit.INDEX) {
  ...
  } else if (gpuBuffer.usage & jsonAsset.BufferUsageBit.UNIFORM) {
  ...
  } else if (gpuBuffer.usage & jsonAsset.BufferUsageBit.INDIRECT) {
    gpuBuffer.glTarget = gl.NONE;
  } else if (gpuBuffer.usage & jsonAsset.BufferUsageBit.TRANSFER_DST) {
    gpuBuffer.glTarget = gl.NONE;
  } else if (gpuBuffer.usage & jsonAsset.BufferUsageBit.TRANSFER_SRC) {
    gpuBuffer.glTarget = gl.NONE;
  } else {
...
function WebGL2CmdFuncResizeBuffer(device, gpuBuffer) {
  ...
  if (gpuBuffer.usage & jsonAsset.BufferUsageBit.VERTEX) {
    ...
    gl.bindBuffer(gl.UNIFORM_BUFFER, null);
    device.stateCache.glUniformBuffer = null;
  } else if (gpuBuffer.usage & jsonAsset.BufferUsageBit.INDIRECT || gpuBuffer.usage & jsonAsset.BufferUsageBit.TRANSFER_DST || gpuBuffer.usage & jsonAsset.BufferUsageBit.TRANSFER_SRC) {
    gpuBuffer.glTarget = gl.NONE;
  } else {
    console.error('Unsupported BufferType, create buffer failed.');
    gpuBuffer.glTarget = gl.NONE;
...
function WebGL2CmdFuncUpdateBuffer(device, gpuBuffer, buffer, offset, size) {
  if (gpuBuffer.usage & jsonAsset.BufferUsageBit.INDIRECT) {
...
function WebGL2CmdFuncCreateTexture(device, gpuTexture) {
  ...
  switch (gpuTexture.type) {
    case jsonAsset.TextureType.TEX2D:
      {
        gpuTexture.glTarget = gl.TEXTURE_2D;
        var maxSize = Math.max(w, h);

        if (maxSize > device.capabilities.maxTextureSize) {
          jsonAsset.errorID(9100, maxSize, device.capabilities.maxTextureSize);
        }

        if (gpuTexture.samples === jsonAsset.SampleCount.X1) {
          ...
          if (glTexture && gpuTexture.size > 0) {
            ...
            if (gpuTexture.glInternalFmt === webglDefine.WebGLEXT.COMPRESSED_RGB_ETC1_WEBGL) {
              var imgSize = jsonAsset.FormatSize(gpuTexture.format, 2, 2, 1);
              var view = new Uint8Array(imgSize);
              gl.compressedTexImage2D(gl.TEXTURE_2D, 0, gpuTexture.glInternalFmt, 2, 2, 0, view);
            } else if (gpuTexture.flags & jsonAsset.TextureFlagBit.IMMUTABLE) {
              gl.texStorage2D(gl.TEXTURE_2D, gpuTexture.mipLevel, gpuTexture.glInternalFmt, w, h);
            } else if (!jsonAsset.FormatInfos[gpuTexture.format].isCompressed) {
              ...
              for (var _i = 0; _i < gpuTexture.mipLevel; ++_i) {
                var _imgSize = jsonAsset.FormatSize(gpuTexture.format, w, h, 1);
    ...
    case jsonAsset.TextureType.CUBE:
      {
        ...
        if (_maxSize > device.capabilities.maxCubeMapTextureSize) {
          jsonAsset.errorID(9100, _maxSize, device.capabilities.maxTextureSize);
        }
        ...
        if (_glTexture && gpuTexture.size > 0) {
          ...
          if (gpuTexture.glInternalFmt === webglDefine.WebGLEXT.COMPRESSED_RGB_ETC1_WEBGL) {
            for (var f = 0; f < 6; ++f) {
              var _imgSize2 = jsonAsset.FormatSize(gpuTexture.format, 2, 2, 1);
            ...
            for (var _i3 = 0; _i3 < gpuTexture.mipLevel; ++_i3) {
              var _imgSize3 = jsonAsset.FormatSize(gpuTexture.format, w, h, 1);
    ...
    default:
      {
        ...
        gpuTexture.type = jsonAsset.TextureType.TEX2D;
        gpuTexture.glTarget = gl.TEXTURE_2D;
      }
  }
}
...
function WebGL2CmdFuncResizeTexture(device, gpuTexture) {
  ...
  switch (gpuTexture.type) {
    case jsonAsset.TextureType.TEX2D:
      {
        ...
        if (gpuTexture.samples === jsonAsset.SampleCount.X1) {
          ...
          if (!jsonAsset.FormatInfos[gpuTexture.format].isCompressed) {
            for (var i = 0; i < gpuTexture.mipLevel; ++i) {
              gl.texImage2D(gl.TEXTURE_2D, i, gpuTexture.glInternalFmt, w, h, 0, gpuTexture.glFormat, gpuTexture.glType, null);
              w = Math.max(1, w >> 1);
              h = Math.max(1, h >> 1);
            }
          } else if (gpuTexture.glInternalFmt !== webglDefine.WebGLEXT.COMPRESSED_RGB_ETC1_WEBGL) {
            for (var _i4 = 0; _i4 < gpuTexture.mipLevel; ++_i4) {
              var imgSize = jsonAsset.FormatSize(gpuTexture.format, w, h, 1);
              var view = new Uint8Array(imgSize);
    ...
    case jsonAsset.TextureType.CUBE:
      {
        gpuTexture.type = jsonAsset.TextureType.CUBE;
        gpuTexture.glTarget = gl.TEXTURE_CUBE_MAP;

        var _maxSize2 = Math.max(w, h);

        if (_maxSize2 > device.capabilities.maxCubeMapTextureSize) {
          jsonAsset.errorID(9100, _maxSize2, device.capabilities.maxTextureSize);
        }
        ...
        if (!jsonAsset.FormatInfos[gpuTexture.format].isCompressed) {
          ...
          for (var _f3 = 0; _f3 < 6; ++_f3) {
            ...
            for (var _i6 = 0; _i6 < gpuTexture.mipLevel; ++_i6) {
              var _imgSize4 = jsonAsset.FormatSize(gpuTexture.format, w, h, 1);
...
function WebGL2CmdFuncCreateSampler(device, gpuSampler) {
  ...
  if (glSampler) {
    if (gpuSampler.minFilter === jsonAsset.Filter.LINEAR || gpuSampler.minFilter === jsonAsset.Filter.ANISOTROPIC) {
      if (gpuSampler.mipFilter === jsonAsset.Filter.LINEAR || gpuSampler.mipFilter === jsonAsset.Filter.ANISOTROPIC) {
        gpuSampler.glMinFilter = gl.LINEAR_MIPMAP_LINEAR;
      } else if (gpuSampler.mipFilter === jsonAsset.Filter.POINT) {
        gpuSampler.glMinFilter = gl.LINEAR_MIPMAP_NEAREST;
      } else {
        gpuSampler.glMinFilter = gl.LINEAR;
      }
    } else if (gpuSampler.mipFilter === jsonAsset.Filter.LINEAR || gpuSampler.mipFilter === jsonAsset.Filter.ANISOTROPIC) {
    ...
    if (gpuSampler.magFilter === jsonAsset.Filter.LINEAR || gpuSampler.magFilter === jsonAsset.Filter.ANISOTROPIC) {
...
function WebGL2CmdFuncCreateFramebuffer(device, gpuFramebuffer) {
  ...
  if (glFramebuffer) {
    ...
    if (dst) {
      var glAttachment = jsonAsset.FormatInfos[dst.format].hasStencil ? gl.DEPTH_STENCIL_ATTACHMENT : gl.DEPTH_ATTACHMENT;
...
function WebGL2CmdFuncCreateShader(device, gpuShader) {
  ...
  var _loop = function _loop(k) {
    ...
    switch (gpuStage.type) {
      case jsonAsset.ShaderStageFlagBit.VERTEX:
        {
      ...
      case jsonAsset.ShaderStageFlagBit.FRAGMENT:
        {
  ...
  if (gl.getProgramParameter(gpuShader.glProgram, gl.LINK_STATUS)) {
    jsonAsset.debug$1("Shader '" + gpuShader.name + "' compilation succeeded.");
  } else {
  ...
  if (activeBlockCount) {
    ...
    for (var b = 0; b < activeBlockCount; ++b) {
      ...
      if (!block) {
        jsonAsset.error("Block '" + blockName + "' does not bound");
      } else {
        blockIdx = b;
...
function WebGL2CmdFuncCreateInputAssember(device, gpuInputAssembler) {
  ...
  for (var i = 0; i < gpuInputAssembler.attributes.length; ++i) {
    ...
    var size = jsonAsset.FormatInfos[attrib.format].size;
    gpuInputAssembler.glAttribs[i] = {
      name: attrib.name,
      glBuffer: gpuBuffer.glBuffer,
      glType: glType,
      size: size,
      count: jsonAsset.FormatInfos[attrib.format].count,
...
function WebGL2CmdFuncBeginRenderPass(device, gpuRenderPass, gpuFramebuffer, renderArea, clearColors, clearDepth, clearStencil) {
  ...
  if (gpuFramebuffer && gpuRenderPass) {
    ...
    for (var j = 0; j < clearColors.length; ++j) {
      ...
      if (colorAttachment.format !== jsonAsset.Format.UNKNOWN) {
        switch (colorAttachment.loadOp) {
          case jsonAsset.LoadOp.LOAD:
            break;

          case jsonAsset.LoadOp.CLEAR:
            {
              if (cache.bs.targets[0].blendColorMask !== jsonAsset.ColorMask.ALL) {
    ...
    if (gpuRenderPass.depthStencilAttachment) {
      if (gpuRenderPass.depthStencilAttachment.format !== jsonAsset.Format.UNKNOWN) {
        ...
        if (jsonAsset.FormatInfos[gpuRenderPass.depthStencilAttachment.format].hasStencil) {
    ...
    if (clears & gl.COLOR_BUFFER_BIT) {
      ...
      if (colorMask !== jsonAsset.ColorMask.ALL) {
        var r = (colorMask & jsonAsset.ColorMask.R) !== jsonAsset.ColorMask.NONE;
        var g = (colorMask & jsonAsset.ColorMask.G) !== jsonAsset.ColorMask.NONE;
        var b = (colorMask & jsonAsset.ColorMask.B) !== jsonAsset.ColorMask.NONE;
        var a = (colorMask & jsonAsset.ColorMask.A) !== jsonAsset.ColorMask.NONE;
...
function WebGL2CmdFuncBindStates(device, gpuPipelineState, gpuInputAssembler, gpuDescriptorSets, dynamicOffsets, dynamicStates) {
  ...
  if (gpuPipelineState && gfxStateCache.gpuPipelineState !== gpuPipelineState) {
    ...
    if (rs) {
      if (cache.rs.cullMode !== rs.cullMode) {
        switch (rs.cullMode) {
          case jsonAsset.CullMode.NONE:
            {
              gl.disable(gl.CULL_FACE);
              break;
            }

          case jsonAsset.CullMode.FRONT:
            {
    ...
    if (bs) {
      ...
      if (target0Cache.blendColorMask !== target0.blendColorMask) {
        gl.colorMask((target0.blendColorMask & jsonAsset.ColorMask.R) !== jsonAsset.ColorMask.NONE, (target0.blendColorMask & jsonAsset.ColorMask.G) !== jsonAsset.ColorMask.NONE, (target0.blendColorMask & jsonAsset.ColorMask.B) !== jsonAsset.ColorMask.NONE, (target0.blendColorMask & jsonAsset.ColorMask.A) !== jsonAsset.ColorMask.NONE);
  ...
  if (gpuPipelineState && gpuPipelineState.gpuPipelineLayout && gpuShader) {
    ...
    for (var j = 0; j < blockLen; j++) {
      ...
      if (!gpuDescriptor || !gpuDescriptor.gpuBuffer) {
        jsonAsset.error("Buffer binding '" + glBlock.name + "' at set " + glBlock.set + " binding " + glBlock.binding + " is not bounded");
        continue;
      }
    ...
    for (var i = 0; i < samplerLen; i++) {
      ...
      for (var l = 0; l < glSampler.units.length; l++) {
        ...
        if (!_gpuDescriptor || !_gpuDescriptor.gpuTexture || !_gpuDescriptor.gpuSampler) {
          jsonAsset.error("Sampler binding '" + glSampler.name + "' at set " + glSampler.set + " binding " + glSampler.binding + " index " + l + " is not bounded");
          continue;
        }
  ...
  if (gpuPipelineState && gpuPipelineState.dynamicStates.length) {
    ...
    for (var _k6 = 0; _k6 < dsLen; _k6++) {
      ...
      switch (dynamicState) {
        case jsonAsset.DynamicStateFlagBit.VIEWPORT:
          {
        ...
        case jsonAsset.DynamicStateFlagBit.SCISSOR:
          {
        ...
        case jsonAsset.DynamicStateFlagBit.LINE_WIDTH:
          {
        ...
        case jsonAsset.DynamicStateFlagBit.DEPTH_BIAS:
          {
        ...
        case jsonAsset.DynamicStateFlagBit.BLEND_CONSTANTS:
          {
        ...
        case jsonAsset.DynamicStateFlagBit.STENCIL_WRITE_MASK:
          {
        ...
        case jsonAsset.DynamicStateFlagBit.STENCIL_COMPARE_MASK:
          {
...
function WebGL2CmdFuncCopyTexImagesToTexture(device, texImages, gpuTexture, regions) {
  ...
  if (gpuTexture.flags & jsonAsset.TextureFlagBit.GEN_MIPMAP) {
...
function WebGL2CmdFuncCopyBuffersToTexture(device, buffers, gpuTexture, regions) {
  ...
  var h = 1;
  var f = 0;
  var fmtInfo = jsonAsset.FormatInfos[gpuTexture.format];
...
function WebGL2CmdFuncBlitFramebuffer(device, src, dst, srcRect, dstRect, filter) {
  ...
  if (src.gpuDepthStencilTexture) {
    ...
    if (jsonAsset.FormatInfos[src.gpuDepthStencilTexture.format].hasStencil) {
      mask |= gl.STENCIL_BUFFER_BIT;
    }
  }

  var glFilter = filter === jsonAsset.Filter.LINEAR || filter === jsonAsset.Filter.ANISOTROPIC ? gl.LINEAR : gl.NEAREST;
...
var WebGL2Buffer = function (_Buffer) {
  jsonAsset._inheritsLoose(WebGL2Buffer, _Buffer);
  ...
  _proto.initialize = function initialize(info) {
    if ('buffer' in info) {
      ...
      if (this._usage & jsonAsset.BufferUsageBit.INDIRECT) {
        this._indirectBuffer = new jsonAsset.IndirectBuffer();
      }
      ...
      if (info.usage & jsonAsset.BufferUsageBit.INDIRECT) {
  ...
  _proto.update = function update(buffer, size) {
    ...
    if (size !== undefined) {
      buffSize = size;
    } else if (this._usage & jsonAsset.BufferUsageBit.INDIRECT) {
      buffSize = 0;
    } else {
  ...
  jsonAsset._createClass(WebGL2Buffer, [{
    key: "gpuBuffer",
    get: function get() {
...
var WebGL2CommandPool = function () {
  function WebGL2CommandPool(Clazz, count) {
    ...
    this._freeCmds = new jsonAsset.CachedArray(count);
...
var WebGL2CommandBuffer = function (_CommandBuffer) {
  jsonAsset._inheritsLoose(WebGL2CommandBuffer, _CommandBuffer);
  ...
  function WebGL2CommandBuffer() {
    ...
    _this._curDynamicStates = new jsonAsset.DynamicStates();
  ...
  _proto.setStencilWriteMask = function setStencilWriteMask(face, writeMask) {
    ...
    if (face & jsonAsset.StencilFace.FRONT) {
    ...
    if (face & jsonAsset.StencilFace.BACK) {
  ...
  _proto.draw = function draw(info) {
    if (this._type === jsonAsset.CommandBufferType.PRIMARY && this._isInRenderPass || this._type === jsonAsset.CommandBufferType.SECONDARY) {
      if (this._isStateInvalied) {
        this.bindStates();
      }
  ...
  _proto.updateBuffer = function updateBuffer(buffer, data, size) {
    if (this._type === jsonAsset.CommandBufferType.PRIMARY && !this._isInRenderPass || this._type === jsonAsset.CommandBufferType.SECONDARY) {
      ...
      if (gpuBuffer) {
        ...
        if (buffer.usage & jsonAsset.BufferUsageBit.INDIRECT) {
          buff = data;
        } else {
          if (size !== undefined) {
            buffSize = size;
  ...
  jsonAsset._createClass(WebGL2CommandBuffer, [{
    key: "webGLDevice",
    get: function get() {
      return this._device;
    }
...
}(jsonAsset.CommandBuffer);

var WebGL2Framebuffer = function (_Framebuffer) {
  jsonAsset._inheritsLoose(WebGL2Framebuffer, _Framebuffer);
  ...
  jsonAsset._createClass(WebGL2Framebuffer, [{
    key: "gpuFramebuffer",
    get: function get() {
...
}(jsonAsset.Framebuffer);

var WebGL2InputAssembler = function (_InputAssembler) {
  jsonAsset._inheritsLoose(WebGL2InputAssembler, _InputAssembler);
  ...
  jsonAsset._createClass(WebGL2InputAssembler, [{
...
}(jsonAsset.InputAssembler);

var WebGL2DescriptorSetLayout = function (_DescriptorSetLayout) {
  jsonAsset._inheritsLoose(WebGL2DescriptorSetLayout, _DescriptorSetLayout);
  ...
  _proto.initialize = function initialize(info) {
    ...
    for (var _i2 = 0; _i2 < this._bindings.length; _i2++) {
      ...
      if (_binding2.descriptorType & jsonAsset.DESCRIPTOR_DYNAMIC_TYPE) {
  ...
  jsonAsset._createClass(WebGL2DescriptorSetLayout, [{
...
}(jsonAsset.DescriptorSetLayout);

var WebGL2PipelineLayout = function (_PipelineLayout) {
  jsonAsset._inheritsLoose(WebGL2PipelineLayout, _PipelineLayout);
  ...
  jsonAsset._createClass(WebGL2PipelineLayout, [{
...
var WebGL2PipelineState = function (_PipelineState) {
  jsonAsset._inheritsLoose(WebGL2PipelineState, _PipelineState);
  ...
  jsonAsset._createClass(WebGL2PipelineState, [{
...
}(jsonAsset.PipelineState);

var WebGL2PrimaryCommandBuffer = function (_WebGL2CommandBuffer) {
  jsonAsset._inheritsLoose(WebGL2PrimaryCommandBuffer, _WebGL2CommandBuffer);
  ...
  _proto.updateBuffer = function updateBuffer(buffer, data, size) {
    if (!this._isInRenderPass) {
      ...
      if (gpuBuffer) {
        ...
        if (size !== undefined) {
          buffSize = size;
        } else if (buffer.usage & jsonAsset.BufferUsageBit.INDIRECT) {
          buffSize = 0;
        } else {
          buffSize = data.byteLength;
        }
...
var WebGL2Queue = function (_Queue) {
  jsonAsset._inheritsLoose(WebGL2Queue, _Queue);
...
var WebGL2RenderPass = function (_RenderPass) {
  jsonAsset._inheritsLoose(WebGL2RenderPass, _RenderPass);
  ...
  jsonAsset._createClass(WebGL2RenderPass, [{
    key: "gpuRenderPass",
    get: function get() {
...
}(jsonAsset.RenderPass);

var WebGL2Sampler = function (_Sampler) {
  jsonAsset._inheritsLoose(WebGL2Sampler, _Sampler);
  ...
  jsonAsset._createClass(WebGL2Sampler, [{
    key: "gpuSampler",
    get: function get() {
...
var WebGL2Shader = function (_Shader) {
  jsonAsset._inheritsLoose(WebGL2Shader, _Shader);
  ...
  jsonAsset._createClass(WebGL2Shader, [{
    key: "gpuShader",
    get: function get() {
...
var WebGL2StateCache = function () {
  function WebGL2StateCache() {
    ...
    this.viewport = new jsonAsset.Viewport();
    this.scissorRect = new jsonAsset.Rect(0, 0, 0, 0);
    this.rs = new jsonAsset.RasterizerState();
    this.dss = new jsonAsset.DepthStencilState();
    this.bs = new jsonAsset.BlendState();
    this.glProgram = null;
...
var WebGL2Texture = function (_Texture) {
  jsonAsset._inheritsLoose(WebGL2Texture, _Texture);
  ...
  _proto.initialize = function initialize(info) {
    ...
    this._flags = info.flags;
    this._isPowerOf2 = jsonAsset.IsPowerOf2(this._width) && jsonAsset.IsPowerOf2(this._height);
    this._size = jsonAsset.FormatSurfaceSize(this._format, this.width, this.height, this.depth, this._levelCount) * this._layerCount;
    this._gpuTexture = {
      type: this._type,
      format: this._format,
      usage: this._usage,
  ...
  jsonAsset._createClass(WebGL2Texture, [{
    key: "gpuTexture",
    get: function get() {
...
var WebGL2Device = function (_Device) {
  jsonAsset._inheritsLoose(WebGL2Device, _Device);
  ...
  function WebGL2Device() {
    ...
    _this._useVAO = true;
    _this._bindingMappingInfo = new jsonAsset.BindingMappingInfo();
  ...
  _proto.initialize = function initialize(info) {
    ...
    try {
      var webGLCtxAttribs = {
        alpha: jsonAsset.macro.ENABLE_TRANSPARENT_CANVAS,
    ...
    this._gfxAPI = jsonAsset.API.WEBGL2;
    ...
    this._width = info.width;
    this._height = info.height;
    this._colorFmt = jsonAsset.Format.RGBA8;

    if (this._caps.depthBits === 32) {
      if (this._caps.stencilBits === 8) {
        this._depthStencilFmt = jsonAsset.Format.D32F_S8;
      } else {
        this._depthStencilFmt = jsonAsset.Format.D32F;
      }
    } else if (this._caps.depthBits === 24) {
      if (this._caps.stencilBits === 8) {
        this._depthStencilFmt = jsonAsset.Format.D24S8;
      } else {
        this._depthStencilFmt = jsonAsset.Format.D24;
      }
    } else if (this._caps.stencilBits === 8) {
      this._depthStencilFmt = jsonAsset.Format.D16S8;
    } else {
      this._depthStencilFmt = jsonAsset.Format.D16;
    }
    ...
    if (this._extensions) {
      for (var _iterator = jsonAsset._createForOfIteratorHelperLoose(this._extensions), _step; !(_step = _iterator()).done;) {
        var ext = _step.value;
        extensions += ext + " ";
      }

      jsonAsset.debug$1("EXTENSIONS: " + extensions);
    }
    ...
    this._features[jsonAsset.Feature.TEXTURE_FLOAT] = true;
    this._features[jsonAsset.Feature.TEXTURE_HALF_FLOAT] = true;
    this._features[jsonAsset.Feature.FORMAT_R11G11B10F] = true;
    this._features[jsonAsset.Feature.FORMAT_SRGB] = true;
    this._features[jsonAsset.Feature.FORMAT_RGB8] = true;
    this._features[jsonAsset.Feature.ELEMENT_INDEX_UINT] = true;
    this._features[jsonAsset.Feature.INSTANCED_ARRAYS] = true;
    this._features[jsonAsset.Feature.MULTIPLE_RENDER_TARGETS] = true;
    this._features[jsonAsset.Feature.BLEND_MINMAX] = true;

    if (this._EXT_color_buffer_float) {
      this._features[jsonAsset.Feature.COLOR_FLOAT] = true;
      this._features[jsonAsset.Feature.COLOR_HALF_FLOAT] = true;
    }

    if (this._OES_texture_float_linear) {
      this._features[jsonAsset.Feature.TEXTURE_FLOAT_LINEAR] = true;
    }

    if (this._OES_texture_half_float_linear) {
      this._features[jsonAsset.Feature.TEXTURE_HALF_FLOAT_LINEAR] = true;
    }

    var compressedFormat = '';

    if (this._WEBGL_compressed_texture_etc1) {
      this._features[jsonAsset.Feature.FORMAT_ETC1] = true;
      compressedFormat += 'etc1 ';
    }

    if (this._WEBGL_compressed_texture_etc) {
      this._features[jsonAsset.Feature.FORMAT_ETC2] = true;
      compressedFormat += 'etc2 ';
    }

    if (this._WEBGL_compressed_texture_s3tc) {
      this._features[jsonAsset.Feature.FORMAT_DXT] = true;
      compressedFormat += 'dxt ';
    }

    if (this._WEBGL_compressed_texture_pvrtc) {
      this._features[jsonAsset.Feature.FORMAT_PVRTC] = true;
      compressedFormat += 'pvrtc ';
    }

    if (this._WEBGL_compressed_texture_astc) {
      this._features[jsonAsset.Feature.FORMAT_ASTC] = true;
      compressedFormat += 'astc ';
    }

    jsonAsset.debug$1("RENDERER: " + this._renderer);
    jsonAsset.debug$1("VENDOR: " + this._vendor);
    jsonAsset.debug$1("VERSION: " + this._version);
    jsonAsset.debug$1("DPR: " + this._devicePixelRatio);
    jsonAsset.debug$1("SCREEN_SIZE: " + this._width + " x " + this._height);
    jsonAsset.debug$1("MAX_VERTEX_ATTRIBS: " + this._caps.maxVertexAttributes);
    jsonAsset.debug$1("MAX_VERTEX_UNIFORM_VECTORS: " + this._caps.maxVertexUniformVectors);
    jsonAsset.debug$1("MAX_FRAGMENT_UNIFORM_VECTORS: " + this._caps.maxFragmentUniformVectors);
    jsonAsset.debug$1("MAX_TEXTURE_IMAGE_UNITS: " + this._caps.maxTextureUnits);
    jsonAsset.debug$1("MAX_VERTEX_TEXTURE_IMAGE_UNITS: " + this._caps.maxVertexTextureUnits);
    jsonAsset.debug$1("MAX_UNIFORM_BUFFER_BINDINGS: " + this._caps.maxUniformBufferBindings);
    jsonAsset.debug$1("MAX_UNIFORM_BLOCK_SIZE: " + this._caps.maxUniformBlockSize);
    jsonAsset.debug$1("DEPTH_BITS: " + this._caps.depthBits);
    jsonAsset.debug$1("STENCIL_BITS: " + this._caps.stencilBits);
    jsonAsset.debug$1("UNIFORM_BUFFER_OFFSET_ALIGNMENT: " + this._caps.uboOffsetAlignment);

    if (this._EXT_texture_filter_anisotropic) {
      jsonAsset.debug$1("MAX_TEXTURE_MAX_ANISOTROPY_EXT: " + this._EXT_texture_filter_anisotropic.MAX_TEXTURE_MAX_ANISOTROPY_EXT);
    }

    jsonAsset.debug$1("USE_VAO: " + this._useVAO);
    jsonAsset.debug$1("COMPRESSED_FORMAT: " + compressedFormat);
    this.initStates(gl);
    this._queue = this.createQueue(new jsonAsset.QueueInfo(jsonAsset.QueueType.GRAPHICS));
    this._cmdBuff = this.createCommandBuffer(new jsonAsset.CommandBufferInfo(this._queue));
    this.nullTex2D = this.createTexture(new jsonAsset.TextureInfo(jsonAsset.TextureType.TEX2D, jsonAsset.TextureUsageBit.SAMPLED, jsonAsset.Format.RGBA8, 2, 2, jsonAsset.TextureFlagBit.GEN_MIPMAP));
    this.nullTexCube = new WebGL2Texture(this);
    this.nullTexCube.initialize(new jsonAsset.TextureInfo(jsonAsset.TextureType.CUBE, jsonAsset.TextureUsageBit.SAMPLED, jsonAsset.Format.RGBA8, 2, 2, jsonAsset.TextureFlagBit.GEN_MIPMAP, 6));
    var nullTexRegion = new jsonAsset.BufferTextureCopy();
  ...
  _proto.resize = function resize(width, height) {
    if (this._width !== width || this._height !== height) {
      jsonAsset.debug$1("Resizing device: " + width + "x" + height);
  ...
  _proto.createCommandBuffer = function createCommandBuffer(info) {
    var Ctor = info.type === jsonAsset.CommandBufferType.PRIMARY ? WebGL2PrimaryCommandBuffer : WebGL2CommandBuffer;
  ...
  _proto.createGlobalBarrier = function createGlobalBarrier(info) {
    var barrier = new jsonAsset.GlobalBarrier(this);
  ...
  _proto.createTextureBarrier = function createTextureBarrier(info) {
    var barrier = new jsonAsset.TextureBarrier(this);
  ...
  _proto.copyFramebufferToBuffer = function copyFramebufferToBuffer(srcFramebuffer, dstBuffer, regions) {
    ...
    var Ctor = jsonAsset.getTypedArrayConstructor(jsonAsset.FormatInfos[format]);
    ...
    for (var _iterator2 = jsonAsset._createForOfIteratorHelperLoose(regions), _step2; !(_step2 = _iterator2()).done;) {
  ...
  _proto._onWebGLContextLost = function _onWebGLContextLost(event) {
    jsonAsset.warnID(11000);
    jsonAsset.warn(event);
  };

  jsonAsset._createClass(WebGL2Device, [{
    key: "gl",
    get: function get() {
...
jsonAsset.legacyCC.WebGL2Device = WebGL2Device;
