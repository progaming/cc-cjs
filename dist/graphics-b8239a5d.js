...
jsonAsset.ccenum(exports.LineCap);
...
jsonAsset.ccenum(exports.LineJoin);
...
})(exports.PointFlags || (exports.PointFlags = {}));

jsonAsset.ccenum(exports.PointFlags);
...
function tesselateBezier(ctx, x1, y1, x2, y2, x3, y3, x4, y4, level, type) {
  ...
  if ((d2 + d3) * (d2 + d3) < ctx.tessTol * (dx * dx + dy * dy)) {
    ctx.addPoint(x4, y4, type === 0 ? type | exports.PointFlags.PT_BEVEL : type);
    return;
  }
...
var Point = function (_Vec) {
  jsonAsset._inheritsLoose(Point, _Vec);
...
var Impl = function () {
  function Impl() {
    ...
    this.tessTol = 0.25;
    this.distTol = 0.01;
    this.fillColor = jsonAsset.Color$1.WHITE.clone();
    this.lineCap = exports.LineCap.BUTT;
    this.strokeColor = jsonAsset.Color$1.BLACK.clone();
  ...
  _proto3.moveTo = function moveTo(x, y) {
    ...
    this.addPoint(x, y, exports.PointFlags.PT_CORNER);
    this._commandX = x;
    this._commandY = y;
  };
  ...
  _proto3.bezierCurveTo = function bezierCurveTo(c1x, c1y, c2x, c2y, x, y) {
    ...
    tesselateBezier(this, last.x, last.y, c1x, c1y, c2x, c2y, x, y, 0, exports.PointFlags.PT_CORNER);
    this._commandX = x;
    this._commandY = y;
  };
  ...
  _proto3.clear = function clear() {
    ...
    for (var i = 0, l = dataList.length; i < l; i++) {
      ...
      renderable2d.MeshRenderData.remove(data);
    }
  ...
  _proto3.requestRenderData = function requestRenderData() {
    var renderData = renderable2d.MeshRenderData.add();
...
var attributes = vertexFormat.vfmtPosColor.concat([new jsonAsset.Attribute('a_dist', jsonAsset.Format.R32F)]);
var componentPerVertex = vertexFormat.getComponentPerVertex(attributes);
var stride = vertexFormat.getAttributeStride(attributes);
var Graphics = (_dec = jsonAsset.ccclass('cc.Graphics'), _dec2 = jsonAsset.help(), _dec3 = jsonAsset.executionOrder(110), _dec4 = jsonAsset.menu(), _dec5 = jsonAsset.type(exports.LineJoin), _dec6 = jsonAsset.tooltip(), _dec7 = jsonAsset.type(exports.LineCap), _dec8 = jsonAsset.tooltip(), _dec9 = jsonAsset.tooltip(), _dec10 = jsonAsset.tooltip(), _dec11 = jsonAsset.tooltip(), _dec12 = jsonAsset.visible(), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_class2 = (_temp = _class3 = function (_Renderable2D) {
  jsonAsset._inheritsLoose(Graphics, _Renderable2D);

  jsonAsset._createClass(Graphics, [{
    key: "lineWidth",
    get: function get() {
  ...
  function Graphics() {
    ...
    jsonAsset._initializerDefineProperty(_this, "_lineWidth", _descriptor, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_strokeColor", _descriptor2, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_lineJoin", _descriptor3, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_lineCap", _descriptor4, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_fillColor", _descriptor5, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_miterLimit", _descriptor6, jsonAsset._assertThisInitialized(_this));
  ...
  _proto.onLoad = function onLoad() {
    this.model = index.director.root.createModel(view.Model);
  ...
  _proto.onDestroy = function onDestroy() {
    ...
    if (this.model) {
      index.director.root.destroyModel(this.model);
      this.model = null;
    }
  ...
  _proto.activeSubModel = function activeSubModel(idx) {
    if (!this.model) {
      jsonAsset.warnID(4500, this.node.name);
      return;
    }

    if (this.model.subModels.length <= idx) {
      var gfxDevice = jsonAsset.legacyCC.director.root.device;
      var vertexBuffer = gfxDevice.createBuffer(new jsonAsset.BufferInfo(jsonAsset.BufferUsageBit.VERTEX | jsonAsset.BufferUsageBit.TRANSFER_DST, jsonAsset.MemoryUsageBit.DEVICE, 65535 * stride, stride));
      var indexBuffer = gfxDevice.createBuffer(new jsonAsset.BufferInfo(jsonAsset.BufferUsageBit.INDEX | jsonAsset.BufferUsageBit.TRANSFER_DST, jsonAsset.MemoryUsageBit.DEVICE, 65535 * Uint16Array.BYTES_PER_ELEMENT * 2, Uint16Array.BYTES_PER_ELEMENT));
      var renderMesh = new jsonAsset.RenderingSubMesh([vertexBuffer], attributes, jsonAsset.PrimitiveMode.TRIANGLE_LIST, indexBuffer);
  ...
  return Graphics;
}(renderable2d.Renderable2D), _class3.LineJoin = exports.LineJoin, _class3.LineCap = exports.LineCap, _temp), (jsonAsset._applyDecoratedDescriptor(_class2.prototype, "lineWidth", [jsonAsset.editable], Object.getOwnPropertyDescriptor(_class2.prototype, "lineWidth"), _class2.prototype), jsonAsset._applyDecoratedDescriptor(_class2.prototype, "lineJoin", [_dec5, _dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "lineJoin"), _class2.prototype), jsonAsset._applyDecoratedDescriptor(_class2.prototype, "lineCap", [_dec7, _dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "lineCap"), _class2.prototype), jsonAsset._applyDecoratedDescriptor(_class2.prototype, "strokeColor", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "strokeColor"), _class2.prototype), jsonAsset._applyDecoratedDescriptor(_class2.prototype, "fillColor", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "fillColor"), _class2.prototype), jsonAsset._applyDecoratedDescriptor(_class2.prototype, "miterLimit", [_dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "miterLimit"), _class2.prototype), jsonAsset._applyDecoratedDescriptor(_class2.prototype, "color", [jsonAsset.override, _dec12], Object.getOwnPropertyDescriptor(_class2.prototype, "color"), _class2.prototype), _descriptor = jsonAsset._applyDecoratedDescriptor(_class2.prototype, "_lineWidth", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor2 = jsonAsset._applyDecoratedDescriptor(_class2.prototype, "_strokeColor", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    return jsonAsset.Color$1.BLACK.clone();
  }
}), _descriptor3 = jsonAsset._applyDecoratedDescriptor(_class2.prototype, "_lineJoin", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    return exports.LineJoin.MITER;
  }
}), _descriptor4 = jsonAsset._applyDecoratedDescriptor(_class2.prototype, "_lineCap", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    return exports.LineCap.BUTT;
  }
}), _descriptor5 = jsonAsset._applyDecoratedDescriptor(_class2.prototype, "_fillColor", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor6 = jsonAsset._applyDecoratedDescriptor(_class2.prototype, "_miterLimit", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
