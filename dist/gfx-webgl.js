...
var WebGLDescriptorSet = function (_DescriptorSet) {
  jsonAsset._inheritsLoose(WebGLDescriptorSet, _DescriptorSet);
  ...
  jsonAsset._createClass(WebGLDescriptorSet, [{
...
function GFXFormatToWebGLType(format, gl) {
  switch (format) {
    ...
    case jsonAsset.Format.R16F:
      return webglDefine.WebGLEXT.HALF_FLOAT_OES;
    ...
    case jsonAsset.Format.D16S8:
      return webglDefine.WebGLEXT.UNSIGNED_INT_24_8_WEBGL;
...
function GFXFormatToWebGLInternalFormat(format, gl) {
  switch (format) {
    ...
    case jsonAsset.Format.RGBA16F:
      return webglDefine.WebGLEXT.RGBA16F_EXT;

    case jsonAsset.Format.RGBA32F:
      return webglDefine.WebGLEXT.RGBA32F_EXT;

    case jsonAsset.Format.SRGB8_A8:
      return webglDefine.WebGLEXT.SRGB8_ALPHA8_EXT;
...
var WebGLCmdBeginRenderPass = function (_WebGLCmdObject) {
  jsonAsset._inheritsLoose(WebGLCmdBeginRenderPass, _WebGLCmdObject);
  ...
  function WebGLCmdBeginRenderPass() {
    ...
    _this.clearFlag = jsonAsset.ClearFlagBit.NONE;
    _this.clearColors = [];
...
var WebGLCmdBindStates = function (_WebGLCmdObject2) {
  jsonAsset._inheritsLoose(WebGLCmdBindStates, _WebGLCmdObject2);
...
var WebGLCmdDraw = function (_WebGLCmdObject3) {
  jsonAsset._inheritsLoose(WebGLCmdDraw, _WebGLCmdObject3);
...
var WebGLCmdUpdateBuffer = function (_WebGLCmdObject4) {
  jsonAsset._inheritsLoose(WebGLCmdUpdateBuffer, _WebGLCmdObject4);
...
var WebGLCmdCopyBufferToTexture = function (_WebGLCmdObject5) {
  jsonAsset._inheritsLoose(WebGLCmdCopyBufferToTexture, _WebGLCmdObject5);
...
function WebGLCmdFuncUpdateBuffer(device, gpuBuffer, buffer, offset, size) {
  if (gpuBuffer.usage & jsonAsset.BufferUsageBit.UNIFORM) {
    ...
    case jsonAsset.TextureType.TEX2D:
      {
        ...
        if (!device.WEBGL_depth_texture && jsonAsset.FormatInfos[gpuTexture.format].hasDepth) {
          ...
          if (glTexture && gpuTexture.size > 0) {
            ...
            if (!jsonAsset.FormatInfos[gpuTexture.format].isCompressed) {
              ...
              var _imgSize = jsonAsset.FormatSize(gpuTexture.format, 2, 2, 1);
          ...
          if (!jsonAsset.FormatInfos[gpuTexture.format].isCompressed) {
            ...
            for (var _f = 0; _f < 6; ++_f) {
              ...
              for (var _i3 = 0; _i3 < gpuTexture.mipLevel; ++_i3) {
                var _imgSize2 = jsonAsset.FormatSize(gpuTexture.format, w, h, 1);
            ...
            for (var _f2 = 0; _f2 < 6; ++_f2) {
              var _imgSize3 = jsonAsset.FormatSize(gpuTexture.format, 2, 2, 1);
    ...
    for (var i = 0; i < samplerLen; i++) {
      ...
      for (var _l = 0; _l < texUnitLen; _l++) {
        ...
        if (!_gpuDescriptor || !_gpuDescriptor.gpuSampler) {
          jsonAsset.error("Sampler binding '" + glSampler.name + "' at set " + glSampler.set + " binding " + glSampler.binding + " index " + _l + " is not bounded");
          continue;
        }
...
function WebGLCmdFuncCopyTexImagesToTexture(device, texImages, gpuTexture, regions) {
  ...
  if (gpuTexture.flags & jsonAsset.TextureFlagBit.GEN_MIPMAP && gpuTexture.isPowerOf2) {
    ...
    case gl.TEXTURE_2D:
      {
        for (var i = 0; i < regions.length; i++) {
          ...
          } else if (gpuTexture.glInternalFmt === webglDefine.WebGLEXT.COMPRESSED_RGB_ETC1_WEBGL || device.noCompressedTexSubImage2D) {
...
var WebGLBuffer = function (_Buffer) {
  jsonAsset._inheritsLoose(WebGLBuffer, _Buffer);
  ...
  _proto.initialize = function initialize(info) {
    if ('buffer' in info) {
      ...
      if (this._usage & jsonAsset.BufferUsageBit.UNIFORM && this._size > 0) {
      ...
      if (this._usage & jsonAsset.BufferUsageBit.UNIFORM) {
  ...
  jsonAsset._createClass(WebGLBuffer, [{
    key: "gpuBuffer",
    get: function get() {
...
var WebGLCommandBuffer = function (_CommandBuffer) {
  jsonAsset._inheritsLoose(WebGLCommandBuffer, _CommandBuffer);
  ...
  jsonAsset._createClass(WebGLCommandBuffer, [{
    key: "webGLDevice",
    get: function get() {
      return this._device;
    }
...
var WebGLFramebuffer = function (_Framebuffer) {
  jsonAsset._inheritsLoose(WebGLFramebuffer, _Framebuffer);
  ...
  jsonAsset._createClass(WebGLFramebuffer, [{
    key: "gpuFramebuffer",
    get: function get() {
...
var WebGLInputAssembler = function (_InputAssembler) {
  jsonAsset._inheritsLoose(WebGLInputAssembler, _InputAssembler);
  ...
  jsonAsset._createClass(WebGLInputAssembler, [{
...
var WebGLDescriptorSetLayout = function (_DescriptorSetLayout) {
  jsonAsset._inheritsLoose(WebGLDescriptorSetLayout, _DescriptorSetLayout);
  ...
  jsonAsset._createClass(WebGLDescriptorSetLayout, [{
...
var WebGLPipelineLayout = function (_PipelineLayout) {
  jsonAsset._inheritsLoose(WebGLPipelineLayout, _PipelineLayout);
  ...
  jsonAsset._createClass(WebGLPipelineLayout, [{
...
var WebGLPipelineState = function (_PipelineState) {
  jsonAsset._inheritsLoose(WebGLPipelineState, _PipelineState);
  ...
  jsonAsset._createClass(WebGLPipelineState, [{
...
var WebGLPrimaryCommandBuffer = function (_WebGLCommandBuffer) {
  jsonAsset._inheritsLoose(WebGLPrimaryCommandBuffer, _WebGLCommandBuffer);
...
var WebGLQueue = function (_Queue) {
  jsonAsset._inheritsLoose(WebGLQueue, _Queue);
...
var WebGLRenderPass = function (_RenderPass) {
  jsonAsset._inheritsLoose(WebGLRenderPass, _RenderPass);
  ...
  jsonAsset._createClass(WebGLRenderPass, [{
    key: "gpuRenderPass",
    get: function get() {
...
var WebGLSampler = function (_Sampler) {
  jsonAsset._inheritsLoose(WebGLSampler, _Sampler);
  ...
  _proto.initialize = function initialize(info) {
    ...
    if (minFilter === jsonAsset.Filter.LINEAR || minFilter === jsonAsset.Filter.ANISOTROPIC) {
      if (mipFilter === jsonAsset.Filter.LINEAR || mipFilter === jsonAsset.Filter.ANISOTROPIC) {
        glMinFilter = 0x2703;
      } else if (mipFilter === jsonAsset.Filter.POINT) {
        glMinFilter = 0x2701;
      } else {
        glMinFilter = 0x2601;
      }
    } else if (mipFilter === jsonAsset.Filter.LINEAR || mipFilter === jsonAsset.Filter.ANISOTROPIC) {
      glMinFilter = 0x2702;
    } else if (mipFilter === jsonAsset.Filter.POINT) {
      glMinFilter = 0x2700;
    } else {
    ...
    if (magFilter === jsonAsset.Filter.LINEAR || magFilter === jsonAsset.Filter.ANISOTROPIC) {
      glMagFilter = 0x2601;
    } else {
      glMagFilter = 0x2600;
    }
  ...
  jsonAsset._createClass(WebGLSampler, [{
    key: "gpuSampler",
    get: function get() {
...
var WebGLShader = function (_Shader) {
  jsonAsset._inheritsLoose(WebGLShader, _Shader);
  ...
  jsonAsset._createClass(WebGLShader, [{
    key: "gpuShader",
    get: function get() {
...
var WebGLTexture = function (_Texture) {
  jsonAsset._inheritsLoose(WebGLTexture, _Texture);
  ...
  jsonAsset._createClass(WebGLTexture, [{
    key: "gpuTexture",
    get: function get() {
...
var WebGLDevice = function (_Device) {
  jsonAsset._inheritsLoose(WebGLDevice, _Device);
  ...
  _proto.initialize = function initialize(info) {
    ...
    this._gfxAPI = jsonAsset.API.WEBGL;
    ...
    {
      if (jsonAsset.sys.os !== jsonAsset.OS.IOS || jsonAsset.sys.osMainVersion !== 14 || !jsonAsset.sys.isBrowser) {
      ...
      if (jsonAsset.sys.os === jsonAsset.OS.IOS && jsonAsset.sys.osMainVersion <= 10 || jsonAsset.WECHAT ) {
    ...
    this.nullTexCube = this.createTexture(new jsonAsset.TextureInfo(jsonAsset.TextureType.CUBE, jsonAsset.TextureUsageBit.SAMPLED, jsonAsset.Format.RGBA8, 2, 2, jsonAsset.TextureFlagBit.GEN_MIPMAP, 6));
  ...
  _proto.createCommandBuffer = function createCommandBuffer(info) {
    var Ctor = info.type === jsonAsset.CommandBufferType.PRIMARY ? WebGLPrimaryCommandBuffer : WebGLCommandBuffer;
  ...
  jsonAsset._createClass(WebGLDevice, [{
    key: "gl",
    get: function get() {
...
jsonAsset.legacyCC.WebGLDevice = WebGLDevice;
