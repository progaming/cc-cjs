...
function ConvexPartition(vertices) {
  ...
  var upperDist;
  var p;
  var lowerInt = new jsonAsset.Vec2();
  var upperInt = new jsonAsset.Vec2();
  var lowerIndex = 0;
  var upperIndex = 0;
  var lowerPoly;
  var upperPoly;
...
function CanSee(i, j, vertices) {
  ...
  for (var k = 0; k < vertices.length; ++k) {
    ...
    var intersectionPoint = new jsonAsset.Vec2();
...
exports.PolygonSeparator = PolygonSeparator;
