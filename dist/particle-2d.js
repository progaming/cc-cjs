...
var ZipUtils = require('./ZipUtils-e50271d4.js');

var DURATION_INFINITY = -1;
var START_SIZE_EQUAL_TO_END_SIZE = -1;
var START_RADIUS_EQUAL_TO_END_RADIUS = -1;
var EmitterMode = jsonAsset.Enum({
  GRAVITY: 0,
  RADIUS: 1
});
var PositionType = jsonAsset.Enum({
  FREE: 0,
  RELATIVE: 1,
  GROUPED: 2
});

var ZERO_VEC2 = new jsonAsset.Vec2(0, 0);

var _pos = new jsonAsset.Vec2();

var _tpa = new jsonAsset.Vec2();

var _tpb = new jsonAsset.Vec2();

var _tpc = new jsonAsset.Vec2();

var formatBytes = vertexFormat.getComponentPerVertex(vertexFormat.vfmtPosUvColor);
...
var Particle = function Particle() {
  this.pos = new jsonAsset.Vec2(0, 0);
  this.startPos = new jsonAsset.Vec2(0, 0);
  this.color = new jsonAsset.Color$1(0, 0, 0, 255);
  this.deltaColor = {
    r: 0,
    g: 0,
    b: 0,
  ...
  this.timeToLive = 0;
  this.drawPos = new jsonAsset.Vec2(0, 0);
  this.aspectRatio = 1;
  this.dir = new jsonAsset.Vec2(0, 0);
  this.radialAccel = 0;
...
var ParticlePool = function (_Pool) {
  jsonAsset._inheritsLoose(ParticlePool, _Pool);
...
var Simulator = function () {
  ...
  _proto2.emitParticle = function emitParticle(pos) {
    ...
    particle.color.r = sr = jsonAsset.clampf(startColor.r + startColorVar.r * (Math.random() - 0.5) * 2, 0, 255);
    particle.color.g = sg = jsonAsset.clampf(startColor.g + startColorVar.g * (Math.random() - 0.5) * 2, 0, 255);
    particle.color.b = sb = jsonAsset.clampf(startColor.b + startColorVar.b * (Math.random() - 0.5) * 2, 0, 255);
    particle.color.a = sa = jsonAsset.clampf(startColor.a + startColorVar.a * (Math.random() - 0.5) * 2, 0, 255);
    particle.deltaColor.r = (jsonAsset.clampf(endColor.r + endColorVar.r * (Math.random() - 0.5) * 2, 0, 255) - sr) / timeToLive;
    particle.deltaColor.g = (jsonAsset.clampf(endColor.g + endColorVar.g * (Math.random() - 0.5) * 2, 0, 255) - sg) / timeToLive;
    particle.deltaColor.b = (jsonAsset.clampf(endColor.b + endColorVar.b * (Math.random() - 0.5) * 2, 0, 255) - sb) / timeToLive;
    particle.deltaColor.a = (jsonAsset.clampf(endColor.a + endColorVar.a * (Math.random() - 0.5) * 2, 0, 255) - sa) / timeToLive;
    ...
    var a = jsonAsset.degreesToRadians(psys.angle + this._worldRotation + psys.angleVar * (Math.random() - 0.5) * 2);
    ...
    if (psys.emitterMode === EmitterMode.GRAVITY) {
      ...
      if (psys.rotationIsDir) {
        particle.rotation = -jsonAsset.radiansToDegrees(Math.atan2(particle.dir.y, particle.dir.x));
      }
    } else {
      ...
      particle.angle = a;
      particle.degreesPerSecond = jsonAsset.degreesToRadians(psys.rotatePerS + psys.rotatePerSVar * (Math.random() - 0.5) * 2);
    }
  };
  ...
  _proto2.updateParticleBuffer = function updateParticleBuffer(particle, pos, buffer, offset) {
    ...
    if (particle.rotation) {
      ...
      var x2 = halfWidth;
      var y2 = halfHeight;
      var rad = -jsonAsset.degreesToRadians(particle.rotation);
      var cr = Math.cos(rad);
      var sr = Math.sin(rad);
    ...
    jsonAsset.Color$1.toArray(vbuf, particle.color, offset + 5);
    jsonAsset.Color$1.toArray(vbuf, particle.color, offset + 14);
    jsonAsset.Color$1.toArray(vbuf, particle.color, offset + 23);
    jsonAsset.Color$1.toArray(vbuf, particle.color, offset + 32);
  };
...
var ParticleAsset = (_dec = jsonAsset.ccclass('cc.ParticleAsset'), _dec(_class = (_class2 = (_temp = function (_Asset) {
  jsonAsset._inheritsLoose(ParticleAsset, _Asset);
  ...
  function ParticleAsset() {
    ...
    jsonAsset._initializerDefineProperty(_this, "spriteFrame", _descriptor, jsonAsset._assertThisInitialized(_this));

    return _this;
  }

  return ParticleAsset;
}(jsonAsset.Asset), _temp), (_descriptor = jsonAsset._applyDecoratedDescriptor(_class2.prototype, "spriteFrame", [jsonAsset.serializable, jsonAsset.editable], {
  configurable: true,
  enumerable: true,
  writable: true,
...
jsonAsset.legacyCC.ParticleAsset = ParticleAsset;
...
var PNGReader = function () {
  function PNGReader(data) {
    ...
    while (true) {
      ...
      if (this.pos > this.data.length) {
        throw new Error(jsonAsset.getError(6017));
      }
    }
  }
  ...
  _proto.decodePixels = function decodePixels(data) {
    ...
    var inflate = new ZipUtils._p.Inflate(data, {
      index: 0,
      verify: false
    });
    ...
    while (pos < length) {
      switch (data[pos++]) {
        ...
        default:
          throw new Error(jsonAsset.getError(6018, data[pos - 1]));
      }
...
var TiffReader = function () {
  ...
  _proto.checkLittleEndian = function checkLittleEndian() {
    ...
    if (BOM === 0x4949) {
      ...
      console.log(BOM);
      throw TypeError(jsonAsset.getError(6019));
    }
  ...
  _proto.hasTowel = function hasTowel() {
    if (this.getUint16(2) !== 42) {
      throw RangeError(jsonAsset.getError(6020));
    }
          ...
          case 1:
            ...
            for (var m = 0; m < samplesPerPixel; m++) {
              ...
              if (s.hasBytesPerSample) {
                ...
                throw RangeError(jsonAsset.getError(6025));
              }
            }
            ...
            if (hasBytesPerPixel) {
              ...
              jIncrement = 0;
              throw RangeError(jsonAsset.getError(6026));
            }
              ...
              switch (photometricInterpretation) {
                ...
                case 3:
                  if (colorMapValues === undefined) {
                    throw Error(jsonAsset.getError(6027));
                  }
                ...
                default:
                  throw RangeError(jsonAsset.getError(6028, photometricInterpretation));
              }
            })();
...
var ParticleSystem2D = (_dec$1 = jsonAsset.ccclass('cc.ParticleSystem2D'), _dec2 = jsonAsset.menu(), _dec3 = jsonAsset.tooltip(), _dec4 = jsonAsset.type(ParticleAsset), _dec5 = jsonAsset.tooltip(), _dec6 = jsonAsset.type(spriteFrame.SpriteFrame), _dec7 = jsonAsset.tooltip(), _dec8 = jsonAsset.tooltip(), _dec9 = jsonAsset.tooltip(), _dec10 = jsonAsset.tooltip(), _dec11 = jsonAsset.tooltip(), _dec12 = jsonAsset.tooltip(), _dec13 = jsonAsset.tooltip(), _dec14 = jsonAsset.tooltip(), _dec15 = jsonAsset.visible(), _dec16 = jsonAsset.tooltip(), _dec17 = jsonAsset.tooltip(), _dec18 = jsonAsset.tooltip(), _dec19 = jsonAsset.tooltip(), _dec20 = jsonAsset.tooltip(), _dec21 = jsonAsset.tooltip(), _dec22 = jsonAsset.tooltip(), _dec23 = jsonAsset.tooltip(), _dec24 = jsonAsset.tooltip(), _dec25 = jsonAsset.tooltip(), _dec26 = jsonAsset.tooltip(), _dec27 = jsonAsset.tooltip(), _dec28 = jsonAsset.tooltip(), _dec29 = jsonAsset.type(PositionType), _dec30 = jsonAsset.tooltip(), _dec31 = jsonAsset.type(EmitterMode), _dec32 = jsonAsset.tooltip(), _dec33 = jsonAsset.tooltip(), _dec34 = jsonAsset.tooltip(), _dec35 = jsonAsset.tooltip(), _dec36 = jsonAsset.tooltip(), _dec37 = jsonAsset.tooltip(), _dec38 = jsonAsset.tooltip(), _dec39 = jsonAsset.tooltip(), _dec40 = jsonAsset.tooltip(), _dec41 = jsonAsset.tooltip(), _dec42 = jsonAsset.tooltip(), _dec43 = jsonAsset.tooltip(), _dec44 = jsonAsset.tooltip(), _dec45 = jsonAsset.tooltip(), _dec46 = jsonAsset.tooltip(), _dec47 = jsonAsset.tooltip(), _dec48 = jsonAsset.tooltip(), _dec49 = jsonAsset.formerlySerializedAs('preview'), _dec50 = jsonAsset.tooltip(), _dec$1(_class$1 = _dec2(_class$1 = jsonAsset.playOnFocus(_class$1 = jsonAsset.executeInEditMode(_class$1 = (_class2$1 = (_temp$1 = _class3 = function (_Renderable2D) {
  jsonAsset._inheritsLoose(ParticleSystem2D, _Renderable2D);

  jsonAsset._createClass(ParticleSystem2D, [{
    key: "custom",
    get: function get() {
      return this._custom;
    },
  ...
  function ParticleSystem2D() {
    ...
    jsonAsset._initializerDefineProperty(_this, "duration", _descriptor$1, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "emissionRate", _descriptor2, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "life", _descriptor3, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "lifeVar", _descriptor4, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "angle", _descriptor5, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "angleVar", _descriptor6, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "startSize", _descriptor7, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "startSizeVar", _descriptor8, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "endSize", _descriptor9, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "endSizeVar", _descriptor10, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "startSpin", _descriptor11, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "startSpinVar", _descriptor12, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "endSpin", _descriptor13, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "endSpinVar", _descriptor14, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "sourcePos", _descriptor15, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "posVar", _descriptor16, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "emitterMode", _descriptor17, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "gravity", _descriptor18, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "speed", _descriptor19, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "speedVar", _descriptor20, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "tangentialAccel", _descriptor21, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "tangentialAccelVar", _descriptor22, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "radialAccel", _descriptor23, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "radialAccelVar", _descriptor24, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "rotationIsDir", _descriptor25, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "startRadius", _descriptor26, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "startRadiusVar", _descriptor27, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "endRadius", _descriptor28, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "endRadiusVar", _descriptor29, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "rotatePerS", _descriptor30, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "rotatePerSVar", _descriptor31, jsonAsset._assertThisInitialized(_this));

    _this.aspectRatio = 1;

    jsonAsset._initializerDefineProperty(_this, "playOnLoad", _descriptor32, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "autoRemoveOnFinish", _descriptor33, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_preview", _descriptor34, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_custom", _descriptor35, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_file", _descriptor36, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_spriteFrame", _descriptor37, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_totalParticles", _descriptor38, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_startColor", _descriptor39, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_startColorVar", _descriptor40, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_endColor", _descriptor41, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_endColorVar", _descriptor42, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_positionType", _descriptor43, jsonAsset._assertThisInitialized(_this));
  ...
  _proto._initTextureWithDictionary = function _initTextureWithDictionary(dict) {
    ...
    if (dict.spriteFrameUuid) {
      ...
      index.assetManager.loadAny(spriteFrameUuid, function (err, spriteFrame) {
        if (err) {
      ...
      var imgPath = jsonAsset.changeBasename(this._plistFile, dict.textureFileName || '');

      if (dict.textureFileName) {
        index.assetManager.loadRemote(imgPath, function (err, imageAsset) {
          if (err) {
            ...
            _this2.spriteFrame = spriteFrame.SpriteFrame.createWithImage(imageAsset);
          }
        });
        ...
        if (textureData && textureData.length > 0) {
          var imageAsset = index.assetManager.assets.get(imgPath);

          if (!imageAsset) {
            var buffer = ZipUtils.codec.unzipBase64AsArray(textureData, 1);

            if (!buffer) {
              jsonAsset.warnID(6030, this._file.name);
              return false;
            }
            ...
            if (imageFormat !== ImageFormat.TIFF && imageFormat !== ImageFormat.PNG) {
              jsonAsset.warnID(6031, this._file.name);
              return false;
            }
            ...
            imageAsset = new jsonAsset.ImageAsset(canvasObj);
            index.assetManager.assets.add(imgPath, imageAsset);
          }

          if (!imageAsset) {
            jsonAsset.warnID(6032, this._file.name);
          }

          this.spriteFrame = spriteFrame.SpriteFrame.createWithImage(imageAsset);
        } else {
          return false;
        }
      }
  ...
  _proto._initWithDictionary = function _initWithDictionary(dict) {
    ...
    this._srcBlendFactor = parseInt(dict.blendFuncSource || jsonAsset.BlendFactor.SRC_ALPHA);
    this._dstBlendFactor = parseInt(dict.blendFuncDestination || jsonAsset.BlendFactor.ONE_MINUS_SRC_ALPHA);
...
}(renderable2d.Renderable2D), _class3.EmitterMode = EmitterMode, _class3.PositionType = PositionType, _class3.DURATION_INFINITY = DURATION_INFINITY, _class3.START_SIZE_EQUAL_TO_END_SIZE = START_SIZE_EQUAL_TO_END_SIZE, _class3.START_RADIUS_EQUAL_TO_END_RADIUS = START_RADIUS_EQUAL_TO_END_RADIUS, _temp$1), (jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "custom", [jsonAsset.editable, _dec3], Object.getOwnPropertyDescriptor(_class2$1.prototype, "custom"), _class2$1.prototype), jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "file", [_dec4, _dec5], Object.getOwnPropertyDescriptor(_class2$1.prototype, "file"), _class2$1.prototype), jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "spriteFrame", [_dec6, _dec7], Object.getOwnPropertyDescriptor(_class2$1.prototype, "spriteFrame"), _class2$1.prototype), jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "totalParticles", [jsonAsset.editable, _dec8], Object.getOwnPropertyDescriptor(_class2$1.prototype, "totalParticles"), _class2$1.prototype), _descriptor$1 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "duration", [jsonAsset.serializable, jsonAsset.editable, _dec9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor2 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "emissionRate", [jsonAsset.serializable, jsonAsset.editable, _dec10], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor3 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "life", [jsonAsset.serializable, jsonAsset.editable, _dec11], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor4 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "lifeVar", [jsonAsset.serializable, jsonAsset.editable, _dec12], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "startColor", [jsonAsset.editable, _dec13], Object.getOwnPropertyDescriptor(_class2$1.prototype, "startColor"), _class2$1.prototype), jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "startColorVar", [jsonAsset.editable, _dec14], Object.getOwnPropertyDescriptor(_class2$1.prototype, "startColorVar"), _class2$1.prototype), jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "color", [_dec15], Object.getOwnPropertyDescriptor(_class2$1.prototype, "color"), _class2$1.prototype), jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "endColor", [jsonAsset.editable, _dec16], Object.getOwnPropertyDescriptor(_class2$1.prototype, "endColor"), _class2$1.prototype), jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "endColorVar", [jsonAsset.editable, _dec17], Object.getOwnPropertyDescriptor(_class2$1.prototype, "endColorVar"), _class2$1.prototype), _descriptor5 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "angle", [jsonAsset.serializable, jsonAsset.editable, _dec18], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor6 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "angleVar", [jsonAsset.serializable, jsonAsset.editable, _dec19], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor7 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "startSize", [jsonAsset.serializable, jsonAsset.editable, _dec20], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor8 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "startSizeVar", [jsonAsset.serializable, jsonAsset.editable, _dec21], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor9 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "endSize", [jsonAsset.serializable, jsonAsset.editable, _dec22], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor10 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "endSizeVar", [jsonAsset.serializable, jsonAsset.editable, _dec23], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor11 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "startSpin", [jsonAsset.serializable, jsonAsset.editable, _dec24], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor12 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "startSpinVar", [jsonAsset.serializable, jsonAsset.editable, _dec25], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor13 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "endSpin", [jsonAsset.serializable, jsonAsset.editable, _dec26], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor14 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "endSpinVar", [jsonAsset.serializable, jsonAsset.editable, _dec27], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor15 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "sourcePos", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    return jsonAsset.Vec2.ZERO.clone();
  }
}), _descriptor16 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "posVar", [jsonAsset.serializable, jsonAsset.editable, _dec28], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "positionType", [_dec29, _dec30], Object.getOwnPropertyDescriptor(_class2$1.prototype, "positionType"), _class2$1.prototype), jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "preview", [jsonAsset.editable], Object.getOwnPropertyDescriptor(_class2$1.prototype, "preview"), _class2$1.prototype), _descriptor17 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "emitterMode", [jsonAsset.serializable, jsonAsset.editable, _dec31, _dec32], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor18 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "gravity", [jsonAsset.serializable, jsonAsset.editable, _dec33], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor19 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "speed", [jsonAsset.serializable, jsonAsset.editable, _dec34], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor20 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "speedVar", [jsonAsset.serializable, jsonAsset.editable, _dec35], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor21 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "tangentialAccel", [jsonAsset.serializable, jsonAsset.editable, _dec36], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor22 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "tangentialAccelVar", [jsonAsset.serializable, jsonAsset.editable, _dec37], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor23 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "radialAccel", [jsonAsset.serializable, jsonAsset.editable, _dec38], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor24 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "radialAccelVar", [jsonAsset.serializable, jsonAsset.editable, _dec39], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor25 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "rotationIsDir", [jsonAsset.serializable, jsonAsset.editable, _dec40], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor26 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "startRadius", [jsonAsset.serializable, jsonAsset.editable, _dec41], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor27 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "startRadiusVar", [jsonAsset.serializable, jsonAsset.editable, _dec42], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor28 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "endRadius", [jsonAsset.serializable, jsonAsset.editable, _dec43], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor29 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "endRadiusVar", [jsonAsset.serializable, jsonAsset.editable, _dec44], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor30 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "rotatePerS", [jsonAsset.serializable, jsonAsset.editable, _dec45], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor31 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "rotatePerSVar", [jsonAsset.serializable, jsonAsset.editable, _dec46], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor32 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "playOnLoad", [jsonAsset.serializable, jsonAsset.editable, _dec47], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor33 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "autoRemoveOnFinish", [jsonAsset.serializable, jsonAsset.editable, _dec48], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor34 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "_preview", [_dec49, jsonAsset.editable, _dec50], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor35 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "_custom", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor36 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "_file", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor37 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "_spriteFrame", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor38 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "_totalParticles", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor39 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "_startColor", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    return new jsonAsset.Color$1(255, 255, 255, 255);
  }
}), _descriptor40 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "_startColorVar", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    return new jsonAsset.Color$1(0, 0, 0, 0);
  }
}), _descriptor41 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "_endColor", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    return new jsonAsset.Color$1(255, 255, 255, 0);
  }
}), _descriptor42 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "_endColorVar", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor43 = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "_positionType", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
var Point = function () {
  function Point(point, dir) {
    this.point = new jsonAsset.Vec2();
    this.dir = new jsonAsset.Vec2();
    this.distance = 0;
    this.time = 0;
...
var MotionStreak = (_dec$2 = jsonAsset.ccclass('cc.MotionStreak'), _dec2$1 = jsonAsset.menu(), _dec3$1 = jsonAsset.help(), _dec4$1 = jsonAsset.type(jsonAsset.Texture2D), _dec$2(_class$2 = jsonAsset.executeInEditMode(_class$2 = jsonAsset.playOnFocus(_class$2 = _dec2$1(_class$2 = _dec3$1(_class$2 = (_class2$2 = (_temp$2 = _class3$1 = function (_Renderable2D) {
  jsonAsset._inheritsLoose(MotionStreak, _Renderable2D);
  ...
  function MotionStreak() {
    ...
    jsonAsset._initializerDefineProperty(_this, "_preview", _descriptor$2, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_fadeTime", _descriptor2$1, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_minSeg", _descriptor3$1, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_stroke", _descriptor4$1, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_texture", _descriptor5$1, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_fastMode", _descriptor6$1, jsonAsset._assertThisInitialized(_this));
  ...
  jsonAsset._createClass(MotionStreak, [{
    key: "preview",
    get: function get() {
      return this._preview;
    },
  ...
  return MotionStreak;
}(renderable2d.Renderable2D), _class3$1.Point = Point, _temp$2), (jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "preview", [jsonAsset.editable], Object.getOwnPropertyDescriptor(_class2$2.prototype, "preview"), _class2$2.prototype), jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "fadeTime", [jsonAsset.editable], Object.getOwnPropertyDescriptor(_class2$2.prototype, "fadeTime"), _class2$2.prototype), jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "minSeg", [jsonAsset.editable], Object.getOwnPropertyDescriptor(_class2$2.prototype, "minSeg"), _class2$2.prototype), jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "stroke", [jsonAsset.editable], Object.getOwnPropertyDescriptor(_class2$2.prototype, "stroke"), _class2$2.prototype), jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "texture", [_dec4$1], Object.getOwnPropertyDescriptor(_class2$2.prototype, "texture"), _class2$2.prototype), jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "fastMode", [jsonAsset.editable], Object.getOwnPropertyDescriptor(_class2$2.prototype, "fastMode"), _class2$2.prototype), _descriptor$2 = jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "_preview", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor2$1 = jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "_fadeTime", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor3$1 = jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "_minSeg", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor4$1 = jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "_stroke", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor5$1 = jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "_texture", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor6$1 = jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "_fastMode", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
var _tangent = new jsonAsset.Vec2();

var _normal = new jsonAsset.Vec2();
...
var MotionStreakAssembler = {
  ...
  update: function update(comp, dt) {
    ...
    var ca = color.a;
    var prev = points[1];
    prev.distance = jsonAsset.Vec2.subtract(_vec2, cur.point, prev.point).length();
  ...
  fillBuffers: function fillBuffers(comp, renderer) {
    ...
    for (var i = 0; i < vertexCount; i++) {
      ...
      jsonAsset.Color$1.toArray(vBuf, vert.color, vertexOffset);
      vertexOffset += 4;
    }
...
var ParticleAssembler = {
  ...
  createData: function createData(comp) {
    return renderable2d.MeshRenderData.add();
  },
...
var ParticleSystem2DAssembler = {
  getAssembler: function getAssembler(comp) {
    if (!ParticleAssembler.maxParticleDeltaTime) {
      ParticleAssembler.maxParticleDeltaTime = jsonAsset.legacyCC.game.frameTime / 1000 * 2;
    }
