...
var index$1 = require('./index-04f3192a.js');
...
var CCTextureAtlasData = (_dec = jsonAsset.ccclass('dragonBones.CCTextureAtlasData'), _dec(_class = (_temp = function (_TextureAtlasData) {
  jsonAsset._inheritsLoose(CCTextureAtlasData, _TextureAtlasData);
  ...
  jsonAsset._createClass(CCTextureAtlasData, [{
    key: "renderTexture",
    get: function get() {
        ...
        for (var k in this.textures) {
          ...
          if (!textureData.spriteFrame) {
            ...
            if (textureData.rotated) {
              rect = new jsonAsset.Rect$1(textureData.region.x, textureData.region.y, textureData.region.height, textureData.region.width);
            } else {
              rect = new jsonAsset.Rect$1(textureData.region.x, textureData.region.y, textureData.region.width, textureData.region.height);
              textureData.spriteFrame = new spriteFrame.SpriteFrame();
...
var CCTextureData = (_dec2 = jsonAsset.ccclass('dragonBones.CCTextureData'), _dec2(_class3 = (_temp2 = function (_TextureData) {
  jsonAsset._inheritsLoose(CCTextureData, _TextureData);
...
var CCSlot = (_dec$1 = jsonAsset.ccclass('dragonBones.CCSlot'), _dec$1(_class$1 = (_temp$1 = function (_Slot) {
  jsonAsset._inheritsLoose(CCSlot, _Slot);
  ...
  function CCSlot() {
    ...
    _this._indices = [];
    _this._matrix = new jsonAsset.Mat4();
    _this._worldMatrix = new jsonAsset.Mat4();
    _this._worldMatrixDirty = true;
    _this._visible = false;
    _this._color = new jsonAsset.Color$1();
    return _this;
  }
  ...
  _proto.calculWorldMatrix = function calculWorldMatrix() {
    ...
    if (parent) {
      ...
      jsonAsset.Mat4.copy(this._worldMatrix, this._matrix);
    }
  ...
  _proto._onClear = function _onClear() {
    ...
    jsonAsset.Mat4.identity(this._matrix);
    jsonAsset.Mat4.identity(this._worldMatrix);
    this._worldMatrixDirty = true;
    this._color = new jsonAsset.Color$1();
    this._visible = false;
  };
...
var CCArmatureDisplay = (_dec$2 = jsonAsset.ccclass('dragonBones.CCArmatureDisplay'), _dec$2(_class$2 = (_temp$2 = function (_DisplayData) {
  jsonAsset._inheritsLoose(CCArmatureDisplay, _DisplayData);

  jsonAsset._createClass(CCArmatureDisplay, [{
    key: "node",
    get: function get() {
      return this;
    }
  ...
  function CCArmatureDisplay() {
    ...
    _this._eventTarget = new jsonAsset.EventTarget();
    return _this;
  }
  ...
  _proto.convertToRootSpace = function convertToRootSpace(pos) {
    ...
    var newPos = new jsonAsset.Vec3(0, 0);
...
var CCFactory = (_dec$3 = jsonAsset.ccclass('CCFactory'), _dec$3(_class$3 = (_temp$3 = _class2 = function (_BaseFactory) {
  jsonAsset._inheritsLoose(CCFactory, _BaseFactory);
  ...
  function CCFactory() {
    ...
    if ( index$1.director.getScheduler()) {
      view.game.on(view.Game.EVENT_RESTART, _this.initUpdate, jsonAsset._assertThisInitialized(_this));
  ...
  _proto.initUpdate = function initUpdate(dt) {
    index$1.Scheduler.enableForTarget(this);
    index$1.director.getScheduler().scheduleUpdate(this, index$1.System.Priority.HIGH, false);
  };
...
var _dec$4, _class$4, _class2$1, _descriptor, _temp$4;
var DragonBonesAsset = (_dec$4 = jsonAsset.ccclass('dragonBones.DragonBonesAsset'), _dec$4(_class$4 = (_class2$1 = (_temp$4 = function (_Asset) {
  jsonAsset._inheritsLoose(DragonBonesAsset, _Asset);
  ...
  function DragonBonesAsset() {
    ...
    jsonAsset._initializerDefineProperty(_this, "_dragonBonesJson", _descriptor, jsonAsset._assertThisInitialized(_this));
  ...
  _proto.createNode = function createNode(callback) {
    var node = new jsonAsset.Node(this.name);
  ...
  _proto.getArmatureEnum = function getArmatureEnum() {
    ...
    if (dragonBonesData) {
      ...
      return this._armaturesEnum = jsonAsset.Enum(enumDef);
    }
  ...
  jsonAsset._createClass(DragonBonesAsset, [{
    key: "dragonBonesJson",
    get: function get() {
...
}(jsonAsset.Asset), _temp$4), (_descriptor = jsonAsset._applyDecoratedDescriptor(_class2$1.prototype, "_dragonBonesJson", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
...
jsonAsset.legacyCC.internal.DragonBonesAsset = DragonBonesAsset;

var _dec$5, _dec2$1, _class$5, _class2$2, _descriptor$1, _descriptor2, _descriptor3, _descriptor4, _temp$5;
var DragonBonesAtlasAsset = (_dec$5 = jsonAsset.ccclass('dragonBones.DragonBonesAtlasAsset'), _dec2$1 = jsonAsset.type(jsonAsset.Texture2D), _dec$5(_class$5 = (_class2$2 = (_temp$5 = function (_Asset) {
  jsonAsset._inheritsLoose(DragonBonesAtlasAsset, _Asset);
  ...
  function DragonBonesAtlasAsset() {
    ...
    jsonAsset._initializerDefineProperty(_this, "_atlasJson", _descriptor$1, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_texture", _descriptor2, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_atlasJsonData", _descriptor3, jsonAsset._assertThisInitialized(_this));

    _this._factory = null;

    jsonAsset._initializerDefineProperty(_this, "_textureAtlasData", _descriptor4, jsonAsset._assertThisInitialized(_this));
  ...
  jsonAsset._createClass(DragonBonesAtlasAsset, [{
    key: "atlasJson",
    get: function get() {
...
}(jsonAsset.Asset), _temp$5), (_descriptor$1 = jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "_atlasJson", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor2 = jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "_texture", [jsonAsset.serializable, _dec2$1], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor3 = jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "_atlasJsonData", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor4 = jsonAsset._applyDecoratedDescriptor(_class2$2.prototype, "_textureAtlasData", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
jsonAsset.legacyCC.internal.DragonBonesAtlasAsset = DragonBonesAtlasAsset;

var _dec$6, _class$6, _temp$6;

var _tempMat4 = new jsonAsset.Mat4();

var AttachUtil = (_dec$6 = jsonAsset.ccclass('dragonBones.AttachUtil'), _dec$6(_class$6 = (_temp$6 = function () {
  function AttachUtil() {
    this._inited = false;
    this._armature = null;
...
var ArmatureSystem = function (_System) {
  jsonAsset._inheritsLoose(ArmatureSystem, _System);
  ...
  ArmatureSystem.getInstance = function getInstance() {
    if (!ArmatureSystem._instance) {
      ...
      index$1.director.registerSystem(ArmatureSystem.ID, ArmatureSystem._instance, index$1.System.Priority.HIGH);
    }
...
jsonAsset.legacyCC.internal.ArmatureSystem = ArmatureSystem;

var _dec$7, _dec2$2, _class$7, _class2$3, _descriptor$2, _descriptor2$1, _temp$7, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _dec25, _class4, _class5, _descriptor3$1, _descriptor4$1, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _class6, _temp2$1;
...
jsonAsset.ccenum(DefaultArmaturesEnum);
...
jsonAsset.ccenum(DefaultAnimsEnum);
...
jsonAsset.ccenum(AnimationCacheMode);

function setEnumAttr(obj, propName, enumDef) {
  jsonAsset.CCClass.Attr.setClassAttr(obj, propName, 'type', 'Enum');
  jsonAsset.CCClass.Attr.setClassAttr(obj, propName, 'enumList', jsonAsset.Enum.getList(enumDef));
}

var DragonBoneSocket = (_dec$7 = jsonAsset.ccclass('dragonBones.ArmatureDisplay.DragonBoneSocket'), _dec2$2 = jsonAsset.type(jsonAsset.Node), _dec$7(_class$7 = (_class2$3 = (_temp$7 = function DragonBoneSocket(path, target) {
  if (path === void 0) {
    path = '';
  }
  ...
  jsonAsset._initializerDefineProperty(this, "path", _descriptor$2, this);

  jsonAsset._initializerDefineProperty(this, "target", _descriptor2$1, this);

  this.boneIndex = null;
  this.path = path;
  this.target = target;
}, _temp$7), (_descriptor$2 = jsonAsset._applyDecoratedDescriptor(_class2$3.prototype, "path", [jsonAsset.serializable, jsonAsset.editable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor2$1 = jsonAsset._applyDecoratedDescriptor(_class2$3.prototype, "target", [_dec2$2, jsonAsset.editable, jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
jsonAsset.setClassAlias(DragonBoneSocket, 'dragonBones.ArmatureDisplay.DragonBoneSocket');
var ArmatureDisplay = (_dec3 = jsonAsset.ccclass('dragonBones.ArmatureDisplay'), _dec4 = jsonAsset.help(), _dec5 = jsonAsset.menu(), _dec6 = jsonAsset.type(DragonBonesAsset), _dec7 = jsonAsset.tooltip(), _dec8 = jsonAsset.type(DragonBonesAtlasAsset), _dec9 = jsonAsset.tooltip(), _dec10 = jsonAsset.visible(), _dec11 = jsonAsset.visible(), _dec12 = jsonAsset.displayName(), _dec13 = jsonAsset.type(DefaultArmaturesEnum), _dec14 = jsonAsset.tooltip(), _dec15 = jsonAsset.type(DefaultAnimsEnum), _dec16 = jsonAsset.displayName(), _dec17 = jsonAsset.tooltip(), _dec18 = jsonAsset.displayName(), _dec19 = jsonAsset.tooltip(), _dec20 = jsonAsset.tooltip(), _dec21 = jsonAsset.tooltip(), _dec22 = jsonAsset.tooltip(), _dec23 = jsonAsset.tooltip(), _dec24 = jsonAsset.type([DragonBoneSocket]), _dec25 = jsonAsset.tooltip(), _dec3(_class4 = _dec4(_class4 = _dec5(_class4 = jsonAsset.executeInEditMode(_class4 = (_class5 = (_temp2$1 = _class6 = function (_Renderable2D) {
  jsonAsset._inheritsLoose(ArmatureDisplay, _Renderable2D);

  jsonAsset._createClass(ArmatureDisplay, [{
    key: "dragonAsset",
    get: function get() {
    ...
    set: function set(value) {
      ...
      if (this.dragonAsset) {
        ...
        if (!armaturesEnum) {
          jsonAsset.errorID(7400, this.name);
          return;
        }
      ...
      if (armatureName !== undefined) {
        ...
        jsonAsset.errorID(7401, this.name);
      }
    ...
    set: function set(value) {
      ...
      if (animName !== undefined) {
        ...
        jsonAsset.errorID(7402, this.name);
      }
    }
  }, {
  ...
  function ArmatureDisplay() {
    ...
    jsonAsset._initializerDefineProperty(_this, "playTimes", _descriptor3$1, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "premultipliedAlpha", _descriptor4$1, jsonAsset._assertThisInitialized(_this));

    _this._armature = null;
    _this.attachUtil = void 0;

    jsonAsset._initializerDefineProperty(_this, "_defaultArmatureIndexValue", _descriptor5, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_dragonAsset", _descriptor6, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_dragonAtlasAsset", _descriptor7, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_armatureName", _descriptor8, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_animationName", _descriptor9, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_animationIndexValue", _descriptor10, jsonAsset._assertThisInitialized(_this));

    _this._preCacheMode = -1;
    _this._cacheMode = AnimationCacheMode.REALTIME;

    jsonAsset._initializerDefineProperty(_this, "_defaultCacheModeValue", _descriptor11, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_timeScale", _descriptor12, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_playTimes", _descriptor13, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "_debugBones", _descriptor14, jsonAsset._assertThisInitialized(_this));

    _this._debugDraw = null;

    jsonAsset._initializerDefineProperty(_this, "_enableBatch", _descriptor15, jsonAsset._assertThisInitialized(_this));
    ...
    _this._enumArmatures = jsonAsset.Enum({});
    _this._enumAnimations = jsonAsset.Enum({});
    _this._socketNodes = new Map();
    _this._cachedSockets = new Map();

    jsonAsset._initializerDefineProperty(_this, "_sockets", _descriptor16, jsonAsset._assertThisInitialized(_this));
    ...
    setEnumAttr(jsonAsset._assertThisInitialized(_this), '_animationIndex', _this._enumAnimations);
    setEnumAttr(jsonAsset._assertThisInitialized(_this), '_defaultArmatureIndex', _this._enumArmatures);
    return _this;
  }
  ...
  _proto.requestMeshRenderData = function requestMeshRenderData() {
    ...
    var renderData = new renderable2d.MeshRenderData();
    var comb = {
  ...
  _proto.getMaterialForBlend = function getMaterialForBlend(src, dst) {
    ...
    inst = new view.MaterialInstance(matInfo);
  ...
  _proto._updateDebugDraw = function _updateDebugDraw() {
    if (this.debugBones) {
      if (!this._debugDraw) {
        var debugDrawNode = new jsonAsset.Node('DEBUG_DRAW_NODE');
        debugDrawNode.hideFlags |= jsonAsset.CCObject.Flags.DontSave | jsonAsset.CCObject.Flags.HideInHierarchy;
        var debugDraw = debugDrawNode.addComponent(graphics.Graphics);
        debugDraw.lineWidth = 1;
        debugDraw.strokeColor = new jsonAsset.Color$1(255, 0, 0, 255);
  ...
  _proto.querySocketPathByName = function querySocketPathByName(name) {
    ...
    for (var _iterator = jsonAsset._createForOfIteratorHelperLoose(this._cachedSockets.keys()), _step; !(_step = _iterator()).done;) {
  ...
  _proto._updateCacheModeEnum = function _updateCacheModeEnum() {
    this._cacheModeEnum = jsonAsset.Enum({});
  ...
  _proto._updateAnimEnum = function _updateAnimEnum() {
    ...
    this._enumAnimations = jsonAsset.Enum({});
    Object.assign(this._enumAnimations, animEnum || DefaultAnimsEnum);
    jsonAsset.Enum.update(this._enumAnimations);
  ...
  _proto._updateArmatureEnum = function _updateArmatureEnum() {
    ...
    this._enumArmatures = jsonAsset.Enum({});
    Object.assign(this._enumArmatures, armatureEnum || DefaultArmaturesEnum);
    jsonAsset.Enum.update(this._enumArmatures);
  ...
  _proto._indexBoneSockets = function _indexBoneSockets() {
    ...
    var walkArmature = function walkArmature(prefix, armature) {
      ...
      for (var _iterator2 = jsonAsset._createForOfIteratorHelperLoose(boneToName.keys()), _step2; !(_step2 = _iterator2()).done;) {
...
}(renderable2d.Renderable2D), _class6.AnimationCacheMode = AnimationCacheMode, _temp2$1), (jsonAsset._applyDecoratedDescriptor(_class5.prototype, "dragonAsset", [jsonAsset.editable, _dec6, _dec7], Object.getOwnPropertyDescriptor(_class5.prototype, "dragonAsset"), _class5.prototype), jsonAsset._applyDecoratedDescriptor(_class5.prototype, "dragonAtlasAsset", [jsonAsset.editable, _dec8, _dec9], Object.getOwnPropertyDescriptor(_class5.prototype, "dragonAtlasAsset"), _class5.prototype), jsonAsset._applyDecoratedDescriptor(_class5.prototype, "armatureName", [_dec10], Object.getOwnPropertyDescriptor(_class5.prototype, "armatureName"), _class5.prototype), jsonAsset._applyDecoratedDescriptor(_class5.prototype, "animationName", [_dec11], Object.getOwnPropertyDescriptor(_class5.prototype, "animationName"), _class5.prototype), jsonAsset._applyDecoratedDescriptor(_class5.prototype, "_defaultArmatureIndex", [_dec12, jsonAsset.editable, _dec13, _dec14], Object.getOwnPropertyDescriptor(_class5.prototype, "_defaultArmatureIndex"), _class5.prototype), jsonAsset._applyDecoratedDescriptor(_class5.prototype, "_animationIndex", [jsonAsset.editable, _dec15, _dec16, _dec17], Object.getOwnPropertyDescriptor(_class5.prototype, "_animationIndex"), _class5.prototype), jsonAsset._applyDecoratedDescriptor(_class5.prototype, "_defaultCacheMode", [jsonAsset.editable, _dec18, _dec19], Object.getOwnPropertyDescriptor(_class5.prototype, "_defaultCacheMode"), _class5.prototype), jsonAsset._applyDecoratedDescriptor(_class5.prototype, "timeScale", [jsonAsset.editable, _dec20, jsonAsset.serializable], Object.getOwnPropertyDescriptor(_class5.prototype, "timeScale"), _class5.prototype), _descriptor3$1 = jsonAsset._applyDecoratedDescriptor(_class5.prototype, "playTimes", [_dec21, jsonAsset.editable, jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor4$1 = jsonAsset._applyDecoratedDescriptor(_class5.prototype, "premultipliedAlpha", [jsonAsset.serializable, jsonAsset.editable, _dec22], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), jsonAsset._applyDecoratedDescriptor(_class5.prototype, "debugBones", [_dec23, jsonAsset.editable], Object.getOwnPropertyDescriptor(_class5.prototype, "debugBones"), _class5.prototype), jsonAsset._applyDecoratedDescriptor(_class5.prototype, "sockets", [_dec24, _dec25], Object.getOwnPropertyDescriptor(_class5.prototype, "sockets"), _class5.prototype), _descriptor5 = jsonAsset._applyDecoratedDescriptor(_class5.prototype, "_defaultArmatureIndexValue", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor6 = jsonAsset._applyDecoratedDescriptor(_class5.prototype, "_dragonAsset", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor7 = jsonAsset._applyDecoratedDescriptor(_class5.prototype, "_dragonAtlasAsset", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor8 = jsonAsset._applyDecoratedDescriptor(_class5.prototype, "_armatureName", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor9 = jsonAsset._applyDecoratedDescriptor(_class5.prototype, "_animationName", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor10 = jsonAsset._applyDecoratedDescriptor(_class5.prototype, "_animationIndexValue", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor11 = jsonAsset._applyDecoratedDescriptor(_class5.prototype, "_defaultCacheModeValue", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor12 = jsonAsset._applyDecoratedDescriptor(_class5.prototype, "_timeScale", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor13 = jsonAsset._applyDecoratedDescriptor(_class5.prototype, "_playTimes", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor14 = jsonAsset._applyDecoratedDescriptor(_class5.prototype, "_debugBones", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor15 = jsonAsset._applyDecoratedDescriptor(_class5.prototype, "_enableBatch", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor16 = jsonAsset._applyDecoratedDescriptor(_class5.prototype, "_sockets", [jsonAsset.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
jsonAsset.legacyCC.internal.ArmatureDisplay = ArmatureDisplay;

var NEED_COLOR = 0x01;
var NEED_BATCH = 0x10;
var STRIDE_FLOAT = 9;

var _boneColor = new jsonAsset.Color$1(255, 0, 0, 255);

var _slotColor = new jsonAsset.Color$1(0, 0, 255, 255);

var _originColor = new jsonAsset.Color$1(0, 255, 0, 255);
...
var _vec3u_temp = new jsonAsset.Vec3();
...
function _getSlotMaterial(tex, blendMode) {
  ...
  switch (blendMode) {
    case 1:
      src = _premultipliedAlpha ? jsonAsset.BlendFactor.ONE : jsonAsset.BlendFactor.SRC_ALPHA;
      dst = jsonAsset.BlendFactor.ONE;
      break;

    case 10:
      src = jsonAsset.BlendFactor.DST_COLOR;
      dst = jsonAsset.BlendFactor.ONE_MINUS_SRC_ALPHA;
      break;

    case 12:
      src = jsonAsset.BlendFactor.ONE;
      dst = jsonAsset.BlendFactor.ONE_MINUS_SRC_COLOR;
      break;
...
function realTimeTraverse(armature, parentMat, parentOpacity) {
  ...
  var slotColor;
  var slot;
  var slotMat = new jsonAsset.Mat4();
  ...
  for (var i = 0, l = slots.length; i < l; i++) {
    ...
    if (parentMat) {
      ...
      jsonAsset.Mat4.copy(slot._worldMatrix, slot._matrix);
    }
...
jsonAsset.legacyCC.internal.DragonBonesAssembler = simple;
