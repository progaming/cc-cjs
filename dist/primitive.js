...
function toWavefrontOBJ(primitive, scale) {
  ...
  if (!primitive.indices || !primitive.uvs || !primitive.normals || primitive.primitiveMode !== undefined && primitive.primitiveMode !== jsonAsset.PrimitiveMode.TRIANGLE_LIST) {
    return '';
  }
...
function cone(radius, height, opts) {
  ...
  return capsule.cylinder(0, radius, height, opts);
}

function quad(options) {
  var normalizedOptions = capsule.applyDefaultGeometryOptions(options);
  var result = {
...
function sphere(radius, opts) {
  ...
  var uvs = [];
  var indices = [];
  var minPos = new jsonAsset.Vec3(-radius, -radius, -radius);
  var maxPos = new jsonAsset.Vec3(radius, radius, radius);
...
function torus(radius, tube, opts) {
  ...
  var uvs = [];
  var indices = [];
  var minPos = new jsonAsset.Vec3(-radius - tube, -tube, -radius - tube);
  var maxPos = new jsonAsset.Vec3(radius + tube, tube, radius + tube);
...
function applyDefaultCircleOptions(options) {
  options = capsule.applyDefaultGeometryOptions(options);
  options.segments = 64;
  return options;
}
...
function circle(options) {
  ...
  var result = {
    ...
    boundingRadius: 1,
    primitiveMode: jsonAsset.PrimitiveMode.TRIANGLE_FAN
  };
  return result;
}
...
function wireframed(geometry) {
  ...
  if (geometry.primitiveMode && geometry.primitiveMode !== jsonAsset.PrimitiveMode.TRIANGLE_LIST) {
    return geometry;
  }
  ...
  geometry.primitiveMode = jsonAsset.PrimitiveMode.LINE_LIST;
  return geometry;
}
...
var primitives = /*#__PURE__*/Object.freeze({
    ...
    normals: normals,
    applyDefaultGeometryOptions: capsule.applyDefaultGeometryOptions
});
...
jsonAsset.ccenum(PrimitiveType);
var Primitive = (_dec = jsonAsset.ccclass('cc.Primitive'), _dec2 = jsonAsset.type(PrimitiveType), _dec(_class = (_class2 = (_temp = _class3 = function (_Mesh) {
  jsonAsset._inheritsLoose(Primitive, _Mesh);
  ...
  function Primitive(type) {
    ...
    jsonAsset._initializerDefineProperty(_this, "type", _descriptor, jsonAsset._assertThisInitialized(_this));

    jsonAsset._initializerDefineProperty(_this, "info", _descriptor2, jsonAsset._assertThisInitialized(_this));
  ...
  _proto.onLoaded = function onLoaded() {
    createMesh.createMesh(primitives[PrimitiveType[this.type].toLowerCase()](this.info), this);
  };

  return Primitive;
}(mesh.Mesh), _class3.PrimitiveType = PrimitiveType, _temp), (_descriptor = jsonAsset._applyDecoratedDescriptor(_class2.prototype, "type", [_dec2], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor2 = jsonAsset._applyDecoratedDescriptor(_class2.prototype, "info", [jsonAsset.serializable, jsonAsset.editable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
jsonAsset.legacyCC.Primitive = Primitive;

jsonAsset.legacyCC.primitives = primitives;
